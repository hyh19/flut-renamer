...
class L10n {
  ...
  String get aiRenameRequirementsLabel {
    return Intl.message(
      'Rename instructions',
      name: 'aiRenameRequirementsLabel',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Submit`
  String get aiRenameSubmit {
    return Intl.message('Submit', name: 'aiRenameSubmit', desc: '', args: []);
  }

  /// `Enter rename instructions`
  String get aiRenameSnackbarEmptyRequirements {
    return Intl.message(
      'Enter rename instructions',
      name: 'aiRenameSnackbarEmptyRequirements',
      desc: '',
      args: [],
    );
  }
  ...
  /// `No files selected`
  String get aiRenameSnackbarNoSelection {
    return Intl.message(
      'No files selected',
      name: 'aiRenameSnackbarNoSelection',
      desc: '',
      args: [],
    );
  }
  ...
  String get aiRenameLoading {
    return Intl.message(
      'AI is analyzing your request, please wait...',
      name: 'aiRenameLoading',
      desc: '',
      args: [],
    );
  }
  ...
  String aiRenameSuccess(int count) {
    return Intl.message(
      'AI rename rule created. $count files will be renamed.',
      name: 'aiRenameSuccess',
      desc: '',
      args: [count],
    );
  }

  /// `AI rename failed: {error}`
  String aiRenameError(String error) {
    return Intl.message(
      'AI rename failed: $error',
      name: 'aiRenameError',
      desc: '',
  ...
  /// `AI rename: {requirements}`
  String aiRenameRulePreview(String requirements) {
    return Intl.message(
      'AI rename: $requirements',
      name: 'aiRenameRulePreview',
      desc: '',
      args: [requirements],
    );
  }
