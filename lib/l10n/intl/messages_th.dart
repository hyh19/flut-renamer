...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(error) => "การเปลี่ยนชื่อด้วย AI ล้มเหลว: ${error}";

  static String m1(requirements) => "การเปลี่ยนชื่อด้วย AI: ${requirements}";

  static String m2(count) =>
      "สร้างกฎการเปลี่ยนชื่อด้วย AI แล้ว จะเปลี่ยนชื่อไฟล์ ${count} ไฟล์";

  static String m3(prefix) => "เพิ่ม: ${prefix}เลขดัชนี";
  ...
  static String m6(targetString) => "ลบ: \"${targetString}\"";
  ...
  static String m10(last) => "แก้ไขล่าสุดเมื่อ ${last}";

  static String m11(last, size) => "แก้ไขล่าสุดเมื่อ ${last} ขนาดไฟล์ ${size}";
  ...
  static String m13(type) => "การเปลี่ยนตัวอักษร: ${type}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("เพิ่มแท็กเมตาดาต้า"),
        ...
        "aiRenameRequirementsHint": MessageLookupByLibrary.simpleMessage(
            "อธิบายว่าคุณต้องการเปลี่ยนชื่อไฟล์เหล่านี้อย่างไร"),
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("คำแนะนำการเปลี่ยนชื่อ"),
        "aiRenameRulePreview": m1,
        "aiRenameSnackbarEmptyRequirements":
            MessageLookupByLibrary.simpleMessage(
                "กรุณากรอกคำแนะนำการเปลี่ยนชื่อ"),
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("ไม่มีไฟล์ที่เลือก"),
        "aiRenameSubmit": MessageLookupByLibrary.simpleMessage("ส่ง"),
        "aiRenameSuccess": m2,
        "aiRenameTitle":
            MessageLookupByLibrary.simpleMessage("การเปลี่ยนชื่อด้วย AI"),
        "androidRemindContent": MessageLookupByLibrary.simpleMessage(
            "การใช้ ผู้ช่วยเปลี่ยนชื่อไฟล์แบบกลุ่ม คุณสามารถเปลี่ยนชื่อไฟล์และไดเรกทอรีได้ กดค้างไดเรกทอรีเพื่อเลือก จากนั้นเลือก \'ไฟล์และไดเรกทอรี\' จากปุ่มแบบเลื่อนลงที่มุมบนซ้ายเพื่อเปิดใช้งานการเปลี่ยนชื่อไดเรกทอรี เนื่องจากเหตุผลด้านความปลอดภัย บางไดเรกทอรีที่สงวนไว้สำหรับระบบจะไม่สามารถเลือกได้"),
        "androidRemindTitle":
        ...
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("คัดลอกสแตกข้อผิดพลาด"),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("ปฏิบัติตามภาษาของระบบ"),
        ...
        "themeModeDark": MessageLookupByLibrary.simpleMessage("โหมดมืด"),
        "themeModeLight": MessageLookupByLibrary.simpleMessage("โหมดสว่าง"),
        "themeModeSystem": MessageLookupByLibrary.simpleMessage("ตามระบบ"),
