...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "Inserează „${insert}” la caracterul ${insertIndex}${Intl.select(ordinal, {
            'o1': '-lea',
            'o2': '-lea',
            'o3': '-lea',
            'other': '-lea',
  ...
  static String m8(toEnd) =>
      "Comută numărarea între început și final, în prezent: ${Intl.select(toEnd, {
            'true': 'de la final',
            'false': 'de la început',
            'other': '',
          })}";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
      ...
      "Trunchiază: ${Intl.select(keepType, {
            ...
            'false': 'elimină',
            'other': '',
          })} caracterele dintre caracterul ${iOne}${Intl.select(iTwoOrdinal, {
            'o1': '-lea',
            'o2': '-lea',
            'o3': '-lea',
            'other': '-lea',
            ...
            'false': '',
            'other': '',
          })} și caracterul ${iTwo}${Intl.select(iOneOrdinal, {
            'o1': '-lea',
            'o2': '-lea',
            'o3': '-lea',
            'other': '-lea',
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("Adaugă etichetă de metadate"),
        ...
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("Instrucțiuni de redenumire"),
        ...
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("Niciun fișier selectat"),
        "aiRenameSubmit": MessageLookupByLibrary.simpleMessage("Trimite"),
        "aiRenameSuccess": m2,
        "aiRenameTitle":
            MessageLookupByLibrary.simpleMessage("Redenumire cu AI"),
        ...
        "androidRemindTitle":
            MessageLookupByLibrary.simpleMessage("Redenumirea directoarelor"),
        ...
        "caseSensitive":
            MessageLookupByLibrary.simpleMessage("Sensibil la majuscule"),
        "collapseOptions":
            MessageLookupByLibrary.simpleMessage("Restrânge opțiunile"),
        "colorPicker":
            MessageLookupByLibrary.simpleMessage("Selector de culoare"),
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("Copiază stiva de erori"),
        ...
        "doNotRemindAgain":
            MessageLookupByLibrary.simpleMessage("În regulă. Nu mai afișa."),
        ...
        "expandOptions":
            MessageLookupByLibrary.simpleMessage("Extinde opțiunile"),
        "fileAlreadyExists":
            MessageLookupByLibrary.simpleMessage("Numele este deja folosit"),
        ...
        "fileManagerSaveButton":
            MessageLookupByLibrary.simpleMessage("Adaugă selecțiile în listă"),
        "fileManagerSortButton":
            MessageLookupByLibrary.simpleMessage("Sortează după"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("Selectează stocarea"),
        "fileModifyDate":
            MessageLookupByLibrary.simpleMessage("Data modificării"),
        "fileModifyTime":
            MessageLookupByLibrary.simpleMessage("Ora modificării"),
        "fileNotExist":
            MessageLookupByLibrary.simpleMessage("Fișierul nu există"),
        "fileSize":
            MessageLookupByLibrary.simpleMessage("Dimensiunea fișierului"),
        ...
        "filesDirs":
            MessageLookupByLibrary.simpleMessage("Fișiere și directoare"),
        ...
        "hideHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Ascunde fișiere ascunse"),
        "ifFileNotShown": MessageLookupByLibrary.simpleMessage(
            "Dacă fișierele nu apar în listă, golește totul și continuă."),
        "ignoreExtension":
            MessageLookupByLibrary.simpleMessage("Ignoră extensia"),
        "increment": MessageLookupByLibrary.simpleMessage("Numerotează"),
        "incrementToString": m3,
        "indexIncrementalStep":
            MessageLookupByLibrary.simpleMessage("Pas incremental"),
        "indexOne":
            MessageLookupByLibrary.simpleMessage("Index primul caracter"),
        "indexTwo":
            MessageLookupByLibrary.simpleMessage("Index al doilea caracter"),
        ...
        "insertIndex":
            MessageLookupByLibrary.simpleMessage("Poziție de inserare"),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("Urmează limba sistemului"),
        ...
        "metadataTags":
            MessageLookupByLibrary.simpleMessage("Etichete metadata"),
        "mk": MessageLookupByLibrary.simpleMessage("macedoneană"),
        "mn": MessageLookupByLibrary.simpleMessage("mongolă"),
        "musicAlbumArtist":
            MessageLookupByLibrary.simpleMessage("Artistul albumului"),
        "musicAlbumLength":
            MessageLookupByLibrary.simpleMessage("Numărul de piese din album"),
        ...
        "musicDiscNumber":
            MessageLookupByLibrary.simpleMessage("Numărul discului"),
        "musicGenres": MessageLookupByLibrary.simpleMessage("Genuri muzicale"),
        "musicTrackArtist":
            MessageLookupByLibrary.simpleMessage("Numele artiștilor piesei"),
        "musicTrackDuration":
            MessageLookupByLibrary.simpleMessage("Durata piesei"),
        "musicTrackName": MessageLookupByLibrary.simpleMessage("Numele piesei"),
        "musicTrackNumber":
            MessageLookupByLibrary.simpleMessage("Poziția piesei în album"),
        "musicWriter": MessageLookupByLibrary.simpleMessage("Textierul piesei"),
        "musicYear":
            MessageLookupByLibrary.simpleMessage("Anul lansării piesei"),
        "newName":
            MessageLookupByLibrary.simpleMessage("Previzualizare nume nou"),
        ...
        "photoAltitude":
            MessageLookupByLibrary.simpleMessage("Altitudinea GPS din EXIF"),
        "photoAperture": MessageLookupByLibrary.simpleMessage(
            "Valoarea diafragmei din EXIF"),
        "photoCamName":
            MessageLookupByLibrary.simpleMessage("Numele camerei din EXIF"),
        "photoCopyright": MessageLookupByLibrary.simpleMessage(
            "Numele deținătorului dreptului de autor din EXIF"),
        "photoDate":
            MessageLookupByLibrary.simpleMessage("Data fotografiei din EXIF"),
        "photoFocalLength":
            MessageLookupByLibrary.simpleMessage("Distanța focală din EXIF"),
        "photoISO":
            MessageLookupByLibrary.simpleMessage("Valoarea ISO din EXIF"),
        "photoLatitude":
            MessageLookupByLibrary.simpleMessage("Latitudinea GPS din EXIF"),
        "photoLensName": MessageLookupByLibrary.simpleMessage(
            "Numele obiectivului din EXIF"),
        "photoLongitude":
            MessageLookupByLibrary.simpleMessage("Longitudinea GPS din EXIF"),
        "photoPhotographer": MessageLookupByLibrary.simpleMessage(
            "Numele fotografului din EXIF"),
        "photoShutter":
            MessageLookupByLibrary.simpleMessage("Timpul de expunere din EXIF"),
        "photoTime":
            MessageLookupByLibrary.simpleMessage("Ora fotografiei din EXIF"),
        ...
        "ratingGitHub":
            MessageLookupByLibrary.simpleMessage("Acordă o stea pe GitHub"),
        "ratingStore":
            MessageLookupByLibrary.simpleMessage("Evaluează în store"),
        "ratingTitle":
            MessageLookupByLibrary.simpleMessage("Evaluează aplicația"),
        "rearrange": MessageLookupByLibrary.simpleMessage("Rearanjează"),
        "rearrangeDelimiter":
            MessageLookupByLibrary.simpleMessage("Delimitator"),
        "rearrangeOrderHint": MessageLookupByLibrary.simpleMessage(
            "numere separate prin virgulă"),
        "rearrangeOrderLabel":
            MessageLookupByLibrary.simpleMessage("Ordinea rearanjării"),
        ...
        "removeRule":
            MessageLookupByLibrary.simpleMessage("Elimină această regulă"),
        ...
        "renameFailed":
            MessageLookupByLibrary.simpleMessage("Redenumirea a eșuat"),
        ...
        "showHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Arată fișiere ascunse"),
        ...
        "themeModeSystem":
            MessageLookupByLibrary.simpleMessage("Urmează sistemul"),
