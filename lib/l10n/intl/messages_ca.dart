...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "Inserir \"${insert}\" a la posició ${Intl.select(toEnd, {'true': 'final', 'false': 'inicial', 'other': ''})} a l\'índex ${insertIndex}.";
  ...
  static String m8(toEnd) =>
      "Canviar la direcció de recompte entre des del principi i des del final, actualment comptant des de ${Intl.select(toEnd, {'true': 'el final', 'false': 'el principi', 'other': ''})}";
  ...
  static String m12(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {'true': 'Seleccionat', 'false': 'No seleccionat', 'other': ''})}${Intl.select(entityType, {'File': 'arxiu', 'Directory': 'directori', 'Link': 'enllaç', 'other': 'objecte del sistema d\'arxius'})} amb nom ${filename},";
  ...
  static String m15(
    ...
    iTwo,
      ...
      "Truncar: ${Intl.select(keepType, {'true': 'Mantenir', 'false': 'Eliminar', 'other': ''})} entre els caràcters ${iOne} i ${iTwo}.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "appError": MessageLookupByLibrary.simpleMessage("Error de l\'aplicació"),
    "appInfo": MessageLookupByLibrary.simpleMessage(
      "Informació de l\'aplicació",
    ),
    "appName": MessageLookupByLibrary.simpleMessage("Canvi de Nom d\'Arxius"),
    ...
    "colorPicker": MessageLookupByLibrary.simpleMessage("Selector de color"),
    "copyErrorStack": MessageLookupByLibrary.simpleMessage(
      "Copiar pila d\'errors",
    ),
    ...
    "errorDetails": MessageLookupByLibrary.simpleMessage("Detalls de l\'error"),
    ...
    "expandOptions": MessageLookupByLibrary.simpleMessage("Expandir opcions"),
    ...
    "fileCreateDate": MessageLookupByLibrary.simpleMessage(
      "Data de creació de l\'arxiu",
    ),
    "fileCreateTime": MessageLookupByLibrary.simpleMessage(
      "Hora de creació de l\'arxiu",
    ),
    ...
    "filesDirs": MessageLookupByLibrary.simpleMessage("Arxius i directoris"),
    ...
    "insertBeforeIndex": MessageLookupByLibrary.simpleMessage(
      "Inserir abans de l\'índex",
    ),
    "insertIndex": MessageLookupByLibrary.simpleMessage("Índex d\'inserció"),
    ...
    "musicAlbumName": MessageLookupByLibrary.simpleMessage("Nom de l\'àlbum"),
    "musicAuthor": MessageLookupByLibrary.simpleMessage("Autor de la cançó"),
    "musicDiscNumber": MessageLookupByLibrary.simpleMessage("Número del disc"),
    "musicGenres": MessageLookupByLibrary.simpleMessage("Gèneres de la cançó"),
    ...
    "musicTrackName": MessageLookupByLibrary.simpleMessage("Nom de la cançó"),
    ...
    "musicWriter": MessageLookupByLibrary.simpleMessage(
      "Escriptor de la cançó",
    ),
    "musicYear": MessageLookupByLibrary.simpleMessage("Any de publicació"),
    "newName": MessageLookupByLibrary.simpleMessage("Vista prèvia del nom nou"),
    ...
    "photoAperture": MessageLookupByLibrary.simpleMessage("Obertura (EXIF)"),
    "photoCamName": MessageLookupByLibrary.simpleMessage(
      "Nom de la càmera (EXIF)",
    ),
    ...
    "rating": MessageLookupByLibrary.simpleMessage("Qualificar l\'aplicació"),
    ...
    "ratingGitHub": MessageLookupByLibrary.simpleMessage("Donar like a GitHub"),
    "ratingStore": MessageLookupByLibrary.simpleMessage(
      "Qualificar a la botiga",
    ),
    ...
    "themeModeSystem": MessageLookupByLibrary.simpleMessage("Seguir sistema"),
