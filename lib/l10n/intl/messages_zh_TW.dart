...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "插入：在${Intl.select(toEnd, {
            ...
            'false': '',
            'other': '',
          })}第${insertIndex}個字元處插入「${insert}」。";

  static String m5(delimiter, order) => "重排：分隔符號：${delimiter}，順序：${order}。";
  ...
  static String m8(toEnd) => "切換計數方式為從開頭計數或從末尾計數，目前從${Intl.select(toEnd, {
            'true': '末尾',
            'false': '開頭',
            'other': '',
          })}計數。";

  static String m9(value) => "這是一個下拉按鈕，現在選中的是「${value}」，雙擊以開啟下拉按鈕並選取另一個值。";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
      ...
      "截取：${Intl.select(keepType, {
            ...
            'false': '移除',
            'other': '',
          })}從${Intl.select(iOneToEnd, {
            'true': '倒數的',
            'false': '',
            'other': '',
          })}第${iOne}個字元至${Intl.select(iTwoToEnd, {
            'true': '倒數的',
            'false': '',
            'other': '',
          })}第${iTwo}個字元之間的內容。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addFile": MessageLookupByLibrary.simpleMessage("新增檔案"),
        "addFiles": MessageLookupByLibrary.simpleMessage("請新增檔案。"),
        ...
        "aiRenameError": m0,
        "aiRenameLoading":
            MessageLookupByLibrary.simpleMessage("AI 正在分析您的需求，請稍候..."),
        "aiRenameRequirementsHint":
            MessageLookupByLibrary.simpleMessage("請描述您希望如何重新命名這些檔案。"),
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("重新命名需求描述"),
        "aiRenameRulePreview": m1,
        "aiRenameSnackbarEmptyRequirements":
            MessageLookupByLibrary.simpleMessage("請輸入重新命名需求描述"),
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("沒有選中的檔案"),
        ...
        "appName": MessageLookupByLibrary.simpleMessage("檔案批次重新命名助手"),
        ...
        "descriptionIncrement":
            MessageLookupByLibrary.simpleMessage("遞增檔案名稱，例如 照片-1、照片-2、照片-3。"),
        "descriptionInsert":
            MessageLookupByLibrary.simpleMessage("在指定位置插入指定文字。"),
        "descriptionRearrange": MessageLookupByLibrary.simpleMessage(
            "以使用者指定的分隔符號將檔案名稱分割成若干片段，並根據提供的順序重新排列。"),
        "descriptionRemove":
            MessageLookupByLibrary.simpleMessage("從檔案名稱中刪除指定的文字。"),
        "descriptionReplace":
            MessageLookupByLibrary.simpleMessage("用給定的取代文字取代指定的文字。"),
        ...
        "dragNotSupported":
            MessageLookupByLibrary.simpleMessage("由於系統安全限制，不支援從此應用程式拖放檔案。"),
        "dragToAdd": MessageLookupByLibrary.simpleMessage("拖放檔案進行新增。"),
        "dropToAdd": MessageLookupByLibrary.simpleMessage("在此處釋放檔案。"),
        "errorDetails": MessageLookupByLibrary.simpleMessage("錯誤詳情"),
        "exit": MessageLookupByLibrary.simpleMessage("結束"),
        ...
        "fileAlreadyExists": MessageLookupByLibrary.simpleMessage("檔案名稱已被使用"),
        ...
        "fileManagerSaveButton":
            MessageLookupByLibrary.simpleMessage("新增已選檔案至列表"),
        "fileManagerSortButton": MessageLookupByLibrary.simpleMessage("檔案排序"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("選取儲存器"),
        ...
        "ifFileNotShown":
            MessageLookupByLibrary.simpleMessage("如果檔案列表中未顯示檔案，請清除所有內容並繼續。"),
        ...
        "insertTagInsideAnother":
            MessageLookupByLibrary.simpleMessage("請勿在一個標籤內插入另一個標籤。"),
        "insertToString": m4,
        ...
        "isRegex": MessageLookupByLibrary.simpleMessage("使用正則運算式"),
        ...
        "lowercaseAppName": MessageLookupByLibrary.simpleMessage("檔案批次重新命名助手"),
        "manualMode": MessageLookupByLibrary.simpleMessage("手動模式"),
        "me": MessageLookupByLibrary.simpleMessage("黑山語"),
        "metadataParserNotProvided":
            MessageLookupByLibrary.simpleMessage("包含中繼資料標籤，但未提供中繼資料解析器。"),
        "metadataTags": MessageLookupByLibrary.simpleMessage("中繼資料標籤"),
        ...
        "permissionContent": MessageLookupByLibrary.simpleMessage(
            "為了提供檔案重新命名服務，我們需要您授權我們管理外部儲存。這樣我們才能存取並重新命名您裝置上儲存的檔案。如果沒有此權限，應用程式將無法存取檔案的完整路徑，從而無法進行重新命名操作。我們向您保證，我們非常重視您的隱私和安全，我們只會在重新命名目的下存取檔案。"),
        "permissionTitle": MessageLookupByLibrary.simpleMessage("外部儲存權限"),
        "photoAltitude":
            MessageLookupByLibrary.simpleMessage("照片 GPS 海拔（來自 EXIF）"),
        ...
        "photoCopyright":
            MessageLookupByLibrary.simpleMessage("版權所有者姓名（來自 EXIF）"),
        ...
        "photoLatitude":
            MessageLookupByLibrary.simpleMessage("照片 GPS 緯度（來自 EXIF）"),
        "photoLensName": MessageLookupByLibrary.simpleMessage("鏡頭名稱（來自 EXIF）"),
        "photoLongitude":
            MessageLookupByLibrary.simpleMessage("照片 GPS 經度（來自 EXIF）"),
        "photoPhotographer":
            MessageLookupByLibrary.simpleMessage("攝影師姓名（來自 EXIF）"),
        ...
        "ratingStore": MessageLookupByLibrary.simpleMessage("前往商店評分"),
        "ratingTitle": MessageLookupByLibrary.simpleMessage("評價我們的應用程式"),
        "rearrange": MessageLookupByLibrary.simpleMessage("重排"),
        "rearrangeDelimiter": MessageLookupByLibrary.simpleMessage("分隔符號"),
        "rearrangeOrderHint":
            MessageLookupByLibrary.simpleMessage("請輸入相應數字，以英文逗號隔開"),
        ...
        "semanticNumberWithDirection":
            MessageLookupByLibrary.simpleMessage("切換計數方式為從開頭計數或從末尾計數"),
        ...
        "semanticsFilesDropdownButton":
            MessageLookupByLibrary.simpleMessage("。選擇該項以將重新命名目標限制在該範圍內"),
        "semanticsMultipleActionsHint":
            MessageLookupByLibrary.simpleMessage("，上下滑動切換至其他操作。"),
        "semanticsOpenMetadataDialog":
            MessageLookupByLibrary.simpleMessage("雙擊開啟一個對話框並從中選擇要插入的中繼資料標籤。"),
        ...
        "semanticsRuleDropdownButton":
            MessageLookupByLibrary.simpleMessage("。選擇該項並點擊「新增規則」按鈕即可新增該規則"),
        ...
        "transliterateCyrillic2Latin":
            MessageLookupByLibrary.simpleMessage("從西里爾字元轉為拉丁字元"),
        "transliterateLatin2Cyrillic":
            MessageLookupByLibrary.simpleMessage("從拉丁字元轉為西里爾字元"),
        ...
        "transliterateSimplified":
            MessageLookupByLibrary.simpleMessage("轉換為簡體中文"),
        "transliterateToString": m13,
        "transliterateToStringCyrillic": m14,
        "transliterateTraditional":
            MessageLookupByLibrary.simpleMessage("轉換為繁體中文"),
