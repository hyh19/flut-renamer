...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "fileManagerSaveButton": MessageLookupByLibrary.simpleMessage("新增已選檔案至列表"),
    ...
    "ratingContent": MessageLookupByLibrary.simpleMessage(
      "喜歡我們的應用程式嗎？在應用程式商店給個好評或在GitHub上按讚來幫助我們成長。您的回饋對我們非常重要！感謝您的支持。",
    ),
    "ratingGithub": MessageLookupByLibrary.simpleMessage("在GitHub儲存庫按讚"),
