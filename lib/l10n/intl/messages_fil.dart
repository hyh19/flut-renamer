...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "Ipasok ang \"${insert}\" sa ${insertIndex}${Intl.select(ordinal, {
            'o1': 'st',
            'o2': 'nd',
            'o3': 'rd',
            'other': 'th',
  ...
  static String m8(toEnd) =>
      "Pagpalit ng direksyon ng pagbibilang mula sa simula o sa dulo, kasalukuyang binibilang mula ${Intl.select(toEnd, {
            'true': 'sa dulo',
            'false': 'sa simula',
            'other': '',
          })}";
  ...
  static String m12(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {
            ...
            'Directory': 'Folder',
            'Link': 'Link',
            'other': 'Entity ng file system',
          })}, pangalan ng file ay ${filename}, ";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
      ...
      "Truncate: ${Intl.select(keepType, {
            'true': 'panatilihin lang',
            'false': 'tanggalin',
            'other': '',
          })} ang mga karakter sa pagitan ng ${iOne}${Intl.select(iTwoOrdinal, {
            'o1': 'st',
            'o2': 'nd',
            'o3': 'rd',
            'other': 'th',
            ...
            'false': '',
            'other': '',
          })} na karakter at ${iTwo}${Intl.select(iOneOrdinal, {
            'o1': 'st',
            'o2': 'nd',
            'o3': 'rd',
            'other': 'th',
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addFiles":
            MessageLookupByLibrary.simpleMessage("Magdagdag ng mga file"),
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("Magdagdag ng metadata tag"),
        ...
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("Mga tagubilin sa pag-rename"),
        ...
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("Walang napiling file"),
        "aiRenameSubmit": MessageLookupByLibrary.simpleMessage("Isumite"),
        "aiRenameSuccess": m2,
        "aiRenameTitle":
            MessageLookupByLibrary.simpleMessage("AI na Pag-rename"),
        ...
        "androidRemindTitle":
            MessageLookupByLibrary.simpleMessage("Direktoryo para i-rename"),
        "appError":
            MessageLookupByLibrary.simpleMessage("Error ng application"),
        ...
        "collapseOptions":
            MessageLookupByLibrary.simpleMessage("Itago ang mga opsyon"),
        "colorPicker":
            MessageLookupByLibrary.simpleMessage("Tagapili ng kulay"),
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("Kopyahin ang error stack"),
        "currentName":
            MessageLookupByLibrary.simpleMessage("Kasalukuyang pangalan"),
        ...
        "errorDetails":
            MessageLookupByLibrary.simpleMessage("Detalye ng error"),
        ...
        "expandOptions":
            MessageLookupByLibrary.simpleMessage("Palawakin ang mga opsyon"),
        ...
        "fileCreateTime":
            MessageLookupByLibrary.simpleMessage("Oras ng pagkakagawa ng file"),
        ...
        "fileManagerSortButton":
            MessageLookupByLibrary.simpleMessage("Isaayos ayon sa"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("Piliin ang imbakan"),
        "fileModifyDate":
            MessageLookupByLibrary.simpleMessage("Petsa ng pag-edit ng file"),
        "fileModifyTime":
            MessageLookupByLibrary.simpleMessage("Oras ng pag-edit ng file"),
        "fileNotExist":
            MessageLookupByLibrary.simpleMessage("Walang ganoong file"),
        ...
        "filesDirs":
            MessageLookupByLibrary.simpleMessage("Mga file at direktoryo"),
        ...
        "ignoreExtension":
            MessageLookupByLibrary.simpleMessage("Huwag isama ang extension"),
        ...
        "indexOne":
            MessageLookupByLibrary.simpleMessage("Index ng unang karakter"),
        ...
        "insertBeforeIndex":
            MessageLookupByLibrary.simpleMessage("Ipasok bago ang index"),
        "insertIndex":
            MessageLookupByLibrary.simpleMessage("Index ng pagpasok"),
        "insertTagInsideAnother": MessageLookupByLibrary.simpleMessage(
            "Huwag magpasok ng isang tag sa loob ng ibang tag."),
        "insertToString": m4,
        "insertedText":
            MessageLookupByLibrary.simpleMessage("Text na ipapasok"),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("Sundin ang wika ng system"),
        ...
        "metadataTags":
            MessageLookupByLibrary.simpleMessage("Mga metadata tag"),
        "mk": MessageLookupByLibrary.simpleMessage("Macedonian"),
        "mn": MessageLookupByLibrary.simpleMessage("Mongolian"),
        "musicAlbumArtist":
            MessageLookupByLibrary.simpleMessage("Pangalan ng artist ng album"),
        "musicAlbumLength": MessageLookupByLibrary.simpleMessage(
            "Bilang ng mga track sa album"),
        "musicAlbumName":
            MessageLookupByLibrary.simpleMessage("Pangalan ng album"),
        "musicAuthor":
            MessageLookupByLibrary.simpleMessage("May-akda ng track"),
        "musicDiscNumber":
            MessageLookupByLibrary.simpleMessage("Posisyon ng disc"),
        "musicGenres":
            MessageLookupByLibrary.simpleMessage("Uri ng sining ng musika"),
        "musicTrackArtist": MessageLookupByLibrary.simpleMessage(
            "Mga artist na tumugtog sa track"),
        "musicTrackDuration":
            MessageLookupByLibrary.simpleMessage("Haba ng track"),
        "musicTrackName":
            MessageLookupByLibrary.simpleMessage("Pangalan ng track"),
        "musicTrackNumber":
            MessageLookupByLibrary.simpleMessage("Posisyon ng track sa album"),
        "musicWriter":
            MessageLookupByLibrary.simpleMessage("Manunulat ng track"),
        "musicYear":
            MessageLookupByLibrary.simpleMessage("Taon ng paglabas ng track"),
        ...
        "omitDash":
            MessageLookupByLibrary.simpleMessage("Tanggalin ang gitling"),
        ...
        "photoFocalLength":
            MessageLookupByLibrary.simpleMessage("Haba ng pokus mula sa EXIF"),
        "photoISO":
            MessageLookupByLibrary.simpleMessage("Halagang ISO mula sa EXIF"),
        ...
        "ratingGitHub":
            MessageLookupByLibrary.simpleMessage("Bigyan ng star sa GitHub"),
        "ratingStore":
            MessageLookupByLibrary.simpleMessage("I-rate ang app sa store"),
        "ratingTitle":
            MessageLookupByLibrary.simpleMessage("I-rate ang aming app"),
        "rearrange": MessageLookupByLibrary.simpleMessage("Ayusin muli"),
        "rearrangeDelimiter":
            MessageLookupByLibrary.simpleMessage("Delimiter para ayusin muli"),
        ...
        "removeRenamed":
            MessageLookupByLibrary.simpleMessage("Alisin ang mga na-rename"),
        "removeRule":
            MessageLookupByLibrary.simpleMessage("Alisin ang rule na ito"),
        ...
        "renameFailed":
            MessageLookupByLibrary.simpleMessage("Bigo ang pag-rename"),
        ...
        "sourceCode":
            MessageLookupByLibrary.simpleMessage("Pinagmulan ng code"),
        ...
        "themeModeSystem":
            MessageLookupByLibrary.simpleMessage("Sundin ang system"),
        "tj": MessageLookupByLibrary.simpleMessage("Tajik"),
        "toLast": MessageLookupByLibrary.simpleMessage("-hanggang-huli"),
        "transliterate":
            MessageLookupByLibrary.simpleMessage("Transliterasyon"),
