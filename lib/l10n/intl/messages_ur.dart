...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "${insertIndex}${Intl.select(ordinal, {
            'o1': 'ویں',
            'o2': 'ویں',
            'o3': 'ویں',
            'other': 'ویں',
  ...
  static String m8(toEnd) =>
      "شروع اور آخر سے گنتی کی سمت کے درمیان سوئچ کرنا، فی الحال ${Intl.select(toEnd, {
            'true': 'آخر',
            'false': 'شروع',
            'other': '',
          })} سے گنتی کر رہا ہے";
  ...
  static String m12(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {
            ...
            'Directory': 'فولڈر',
            'Link': 'لنک',
            'other': 'فائل سسٹم انٹیٹی',
          })}, فائل کا نام ${filename} ہے، ";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
      ...
      "کاٹ دیں: ${Intl.select(keepType, {
            ...
            'false': '',
            'other': '',
          })} کریکٹر اور ${iTwo}${Intl.select(iOneOrdinal, {
            'o1': 'ویں',
            'o2': 'ویں',
            'o3': 'ویں',
            'other': 'ویں',
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("میٹا ڈیٹا ٹیگ شامل کریں"),
        ...
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("نام تبدیل کرنے کی ہدایات"),
        ...
        "collapseOptions":
            MessageLookupByLibrary.simpleMessage("اختیارات کو سکیڑیں"),
        "colorPicker": MessageLookupByLibrary.simpleMessage("رنگ منتخب کنندہ"),
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("خرابی کا اسٹیک کاپی کریں"),
        ...
        "errorDetails":
            MessageLookupByLibrary.simpleMessage("خرابی کی تفصیلات"),
        ...
        "expandOptions":
            MessageLookupByLibrary.simpleMessage("اختیارات کو پھیلائیں"),
        "fileAlreadyExists": MessageLookupByLibrary.simpleMessage(
            "فائل کا نام پہلے سے ہی دوسری فائل استعمال کر رہی ہے"),
        "fileCreateDate":
            MessageLookupByLibrary.simpleMessage("فائل بنانے کی تاریخ"),
        "fileCreateTime":
            MessageLookupByLibrary.simpleMessage("فائل بنانے کا وقت"),
        ...
        "fileManagerSortButton":
            MessageLookupByLibrary.simpleMessage("ترتیب دیں"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("اسٹوریج منتخب کریں"),
        "fileModifyDate":
            MessageLookupByLibrary.simpleMessage("فائل میں تبدیلی کی تاریخ"),
        "fileModifyTime":
            MessageLookupByLibrary.simpleMessage("فائل میں تبدیلی کا وقت"),
        "fileNotExist":
            MessageLookupByLibrary.simpleMessage("فائل موجود نہیں ہے"),
        ...
        "filesDirs":
            MessageLookupByLibrary.simpleMessage("فائلیں اور ڈائریکٹریز"),
        ...
        "hideHiddenFiles":
            MessageLookupByLibrary.simpleMessage("پوشیدہ فائلیں چھپائیں"),
        ...
        "ignoreExtension":
            MessageLookupByLibrary.simpleMessage("ایکسٹینشن نظر انداز کریں"),
        "increment": MessageLookupByLibrary.simpleMessage("اضافہ"),
        "incrementToString": m3,
        "indexIncrementalStep":
            MessageLookupByLibrary.simpleMessage("انڈیکس اضافہ قدم"),
        "indexOne":
            MessageLookupByLibrary.simpleMessage("پہلے کریکٹر کا انڈیکس"),
        "indexTwo":
            MessageLookupByLibrary.simpleMessage("دوسرے کریکٹر کا انڈیکس"),
        "insert": MessageLookupByLibrary.simpleMessage("داخل کریں"),
        "insertBeforeIndex":
            MessageLookupByLibrary.simpleMessage("انڈیکس سے پہلے داخل کریں"),
        "insertIndex":
            MessageLookupByLibrary.simpleMessage("داخل کرنے کا انڈیکس"),
        "insertTagInsideAnother": MessageLookupByLibrary.simpleMessage(
            "دوسرے ٹیگ کے اندر ٹیگ داخل نہ کریں۔"),
        "insertToString": m4,
        "insertedText":
            MessageLookupByLibrary.simpleMessage("داخل کرنے کے لیے متن"),
        ...
        "keepCharacters":
            MessageLookupByLibrary.simpleMessage("ان کے درمیان کریکٹرز رکھیں"),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("نظام کی زبان کی پیروی کریں"),
        ...
        "musicAlbumArtist":
            MessageLookupByLibrary.simpleMessage("البم آرٹسٹ کا نام"),
        "musicAlbumLength":
            MessageLookupByLibrary.simpleMessage("البم میں ٹریکس کی تعداد"),
        ...
        "musicDiscNumber":
            MessageLookupByLibrary.simpleMessage("ڈسک کی پوزیشن"),
        "musicGenres":
            MessageLookupByLibrary.simpleMessage("موسیقی کی آرٹ کی قسم"),
        "musicTrackArtist": MessageLookupByLibrary.simpleMessage(
            "ٹریک میں پرفارم کرنے والے آرٹسٹس کے نام"),
        "musicTrackDuration":
            MessageLookupByLibrary.simpleMessage("ٹریک کی مدت"),
        "musicTrackName": MessageLookupByLibrary.simpleMessage("ٹریک کا نام"),
        "musicTrackNumber":
            MessageLookupByLibrary.simpleMessage("البم میں ٹریک کی پوزیشن"),
        "musicWriter": MessageLookupByLibrary.simpleMessage("ٹریک کا مصنف"),
        "musicYear":
            MessageLookupByLibrary.simpleMessage("ٹریک کی اشاعت کا سال"),
        ...
        "permissionTitle":
            MessageLookupByLibrary.simpleMessage("بیرونی اسٹوریج کی اجازت"),
        "photoAltitude":
            MessageLookupByLibrary.simpleMessage("exif سے فوٹو GPS کی بلندی"),
        "photoAperture":
            MessageLookupByLibrary.simpleMessage("exif سے اپرچر کی قیمت"),
        "photoCamName":
            MessageLookupByLibrary.simpleMessage("exif سے کیمرے کا نام"),
        "photoCopyright": MessageLookupByLibrary.simpleMessage(
            "exif سے کاپی رائٹ ہولڈر کا نام"),
        "photoDate":
            MessageLookupByLibrary.simpleMessage("exif سے فوٹوگرافی کی تاریخ"),
        "photoFocalLength":
            MessageLookupByLibrary.simpleMessage("exif سے فوکل لمبائی"),
        ...
        "photoLensName":
            MessageLookupByLibrary.simpleMessage("exif سے لینس کا نام"),
        "photoLongitude": MessageLookupByLibrary.simpleMessage(
            "exif سے فوٹو GPS کی طول البلد"),
        "photoPhotographer":
            MessageLookupByLibrary.simpleMessage("exif سے فوٹوگرافر کا نام"),
        "photoShutter":
            MessageLookupByLibrary.simpleMessage("exif سے شٹر کی رفتار"),
        "photoTime":
            MessageLookupByLibrary.simpleMessage("exif سے فوٹوگرافی کا وقت"),
        ...
        "ratingGitHub":
            MessageLookupByLibrary.simpleMessage("GitHub پر اسے ستارہ دیں"),
        "ratingStore": MessageLookupByLibrary.simpleMessage(
            "اسٹور پر ایپ کی درجہ بندی کریں"),
        "ratingTitle":
            MessageLookupByLibrary.simpleMessage("ہماری ایپ کی درجہ بندی کریں"),
        ...
        "rearrangeOrderHint":
            MessageLookupByLibrary.simpleMessage("کاما سے الگ کیے گئے نمبر"),
        "rearrangeOrderLabel":
            MessageLookupByLibrary.simpleMessage("دوبارہ ترتیب دینے کا ترتیب"),
        ...
        "removeCharacters":
            MessageLookupByLibrary.simpleMessage("ان کے درمیان کریکٹرز ہٹائیں"),
        "removeFile": MessageLookupByLibrary.simpleMessage("فائل ہٹائیں"),
        "removeRenamed":
            MessageLookupByLibrary.simpleMessage("نام تبدیل شدہ فائلیں ہٹائیں"),
        ...
        "renameFailed":
            MessageLookupByLibrary.simpleMessage("نام تبدیل کرنا ناکام"),
        ...
        "showHiddenFiles":
            MessageLookupByLibrary.simpleMessage("پوشیدہ فائلیں دکھائیں"),
        ...
        "themeModeSystem":
            MessageLookupByLibrary.simpleMessage("سسٹم کی پیروی کریں"),
        ...
        "transliterateCyrillic2Latin":
            MessageLookupByLibrary.simpleMessage("سیریلک حروف لاطینی میں"),
        "transliterateLatin2Cyrillic":
            MessageLookupByLibrary.simpleMessage("لاطینی حروف سیریلک میں"),
        "transliterateLower":
            MessageLookupByLibrary.simpleMessage("لاطینی حروف چھوٹے حروف میں"),
        "transliteratePinyin":
            MessageLookupByLibrary.simpleMessage("چینی حروف pinyin میں"),
        "transliterateSimplified":
            MessageLookupByLibrary.simpleMessage("چینی حروف آسان چینی میں"),
        "transliterateToString": m13,
        "transliterateToStringCyrillic": m14,
        "transliterateTraditional":
            MessageLookupByLibrary.simpleMessage("چینی حروف روایتی چینی میں"),
        "transliterateUpper":
            MessageLookupByLibrary.simpleMessage("لاطینی حروف بڑے حروف میں"),
