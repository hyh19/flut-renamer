...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "Sett inn \"${insert}\" ved ${insertIndex}${Intl.select(ordinal, {
            'o1': '.',
            'o2': '.',
            'o3': '.',
            'other': '.',
  ...
  static String m8(toEnd) =>
      "Bytter telle retning mellom fra begynnelsen og fra slutten, teller for øyeblikket fra ${Intl.select(toEnd, {
            'true': 'slutten',
            'false': 'begynnelsen',
            'other': '',
          })}";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
          iOne, iTwo) =>
      "Kutt av: ${Intl.select(keepType, {
            'true': 'behold kun',
            'false': 'fjern',
            'other': '',
          })} tegn mellom ${iOne}${Intl.select(iTwoOrdinal, {
            'o1': '.',
            'o2': '.',
            'o3': '.',
            'other': '.',
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("Legg til metadatatagg"),
        ...
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("Navnendringsinstruksjoner"),
        ...
        "androidRemindTitle":
            MessageLookupByLibrary.simpleMessage("Endre katalognavn"),
        ...
        "caseSensitive":
            MessageLookupByLibrary.simpleMessage("Skiftleggesensitiv"),
        "collapseOptions":
            MessageLookupByLibrary.simpleMessage("Skjul alternativer"),
        "colorPicker": MessageLookupByLibrary.simpleMessage("Fargevelger"),
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("Kopier feilstabel"),
        ...
        "doNotRemindAgain":
            MessageLookupByLibrary.simpleMessage("OK. Ikke påminn meg igjen."),
        ...
        "expandOptions":
            MessageLookupByLibrary.simpleMessage("Utvid alternativer"),
        "fileAlreadyExists": MessageLookupByLibrary.simpleMessage(
            "Filnavnet brukes allerede av en annen fil"),
        "fileCreateDate":
            MessageLookupByLibrary.simpleMessage("Opprettelsesdato for fil"),
        "fileCreateTime":
            MessageLookupByLibrary.simpleMessage("Opprettelsestid for fil"),
        "fileManagerBackButton":
            MessageLookupByLibrary.simpleMessage("Tilbake"),
        "fileManagerSaveButton":
            MessageLookupByLibrary.simpleMessage("Legg til valg til listen"),
        "fileManagerSortButton":
            MessageLookupByLibrary.simpleMessage("Sorter etter"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("Velg lagring"),
        "fileModifyDate":
            MessageLookupByLibrary.simpleMessage("Endringsdato for fil"),
        "fileModifyTime":
            MessageLookupByLibrary.simpleMessage("Endringstid for fil"),
        "fileNotExist":
            MessageLookupByLibrary.simpleMessage("Filen eksisterer ikke"),
        ...
        "ignoreExtension":
            MessageLookupByLibrary.simpleMessage("Ignorer Utvidelse"),
        "increment": MessageLookupByLibrary.simpleMessage("Øk"),
        "incrementToString": m3,
        "indexIncrementalStep":
            MessageLookupByLibrary.simpleMessage("Indeksøkningssteg"),
        ...
        "insertBeforeIndex":
            MessageLookupByLibrary.simpleMessage("Sett inn før indeks"),
        "insertIndex":
            MessageLookupByLibrary.simpleMessage("Innsettingsindeks"),
        "insertTagInsideAnother": MessageLookupByLibrary.simpleMessage(
            "Ikke sett inn en tagg inne i en annen tagg."),
        "insertToString": m4,
        "insertedText":
            MessageLookupByLibrary.simpleMessage("Tekst som skal settes inn"),
        ...
        "iosRemindTitle":
            MessageLookupByLibrary.simpleMessage("Om å velge filer på iOS"),
        "isRegex": MessageLookupByLibrary.simpleMessage("Er regex"),
        "keepCharacters":
            MessageLookupByLibrary.simpleMessage("Behold tegn mellom dem"),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("Følg systemets språk"),
        ...
        "musicAlbumLength":
            MessageLookupByLibrary.simpleMessage("Antall spor i albumet"),
        "musicAlbumName": MessageLookupByLibrary.simpleMessage("Albumets navn"),
        "musicAuthor":
            MessageLookupByLibrary.simpleMessage("Sporets forfatter"),
        "musicDiscNumber":
            MessageLookupByLibrary.simpleMessage("Platens posisjon"),
        "musicGenres":
        ...
        "musicTrackDuration":
            MessageLookupByLibrary.simpleMessage("Sporets varighet"),
        "musicTrackName": MessageLookupByLibrary.simpleMessage("Sporets navn"),
        "musicTrackNumber":
            MessageLookupByLibrary.simpleMessage("Sporets posisjon i albumet"),
        "musicWriter":
            MessageLookupByLibrary.simpleMessage("Sporets forfatter"),
        "musicYear":
            MessageLookupByLibrary.simpleMessage("Utgivelsesår for sporet"),
        ...
        "photoAltitude":
            MessageLookupByLibrary.simpleMessage("Høyde for foto GPS fra exif"),
        "photoAperture":
            MessageLookupByLibrary.simpleMessage("Blendeverdi fra exif"),
        "photoCamName":
        ...
        "photoFocalLength":
            MessageLookupByLibrary.simpleMessage("Brennvidde fra exif"),
        ...
        "ratingGitHub":
            MessageLookupByLibrary.simpleMessage("Stjernemerke den på GitHub"),
        "ratingStore":
            MessageLookupByLibrary.simpleMessage("Vurder appen i butikken"),
        ...
        "rearrangeDelimiter":
            MessageLookupByLibrary.simpleMessage("Omorganiser skilletegn"),
        "rearrangeOrderHint":
            MessageLookupByLibrary.simpleMessage("tall separert med komma"),
        "rearrangeOrderLabel":
            MessageLookupByLibrary.simpleMessage("Omorganiser rekkefølge"),
        ...
        "removeCharacters":
            MessageLookupByLibrary.simpleMessage("Fjern tegn mellom dem"),
        "removeFile": MessageLookupByLibrary.simpleMessage("Fjern fil"),
        "removeRenamed":
            MessageLookupByLibrary.simpleMessage("Fjern omdøpte filer"),
        "removeRule":
            MessageLookupByLibrary.simpleMessage("Fjern denne regelen"),
        ...
        "renameFailed":
            MessageLookupByLibrary.simpleMessage("Navnendring mislyktes"),
