...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(error) =>
      "Yapay zekâ ile yeniden adlandırma başarısız: ${error}";

  static String m1(requirements) =>
      "Yapay zekâ ile yeniden adlandırma: ${requirements}";

  static String m2(count) =>
      "Yapay zekâ yeniden adlandırma kuralı oluşturuldu. ${count} dosya yeniden adlandırılacak.";

  static String m3(prefix) => "Artır: ${prefix} - İndeks";
  ...
  static String m6(targetString) => "Kaldır: \"${targetString}\"";
  ...
  static String m13(type) => "Harf Değiştirme: ${type}.";

  static String m14(langName, type) => "Harf Değiştirme: ${langName} ${type}.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("Metadata etiketi ekle"),
        ...
        "aiRenameSnackbarEmptyRequirements":
            MessageLookupByLibrary.simpleMessage(
                "Yeniden adlandırma talimatlarını girin"),
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("Seçili dosya yok"),
        "aiRenameSubmit": MessageLookupByLibrary.simpleMessage("Gönder"),
        "aiRenameSuccess": m2,
        ...
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("Hata yığınını kopyala"),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("Sistem dilini takip et"),
        ...
        "newName":
            MessageLookupByLibrary.simpleMessage("Yeni Dosya Adı Önizlemesi"),
        ...
        "themeModeDark": MessageLookupByLibrary.simpleMessage("Koyu mod"),
        "themeModeLight": MessageLookupByLibrary.simpleMessage("Açık mod"),
        "themeModeSystem":
            MessageLookupByLibrary.simpleMessage("Sistemi takip et"),
