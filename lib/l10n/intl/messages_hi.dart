...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "\"${insert}\" को ${insertIndex}${Intl.select(ordinal, {'o1': 'वें', 'o2': 'वें', 'o3': 'वें', 'other': 'वें'})}${Intl.select(toEnd, {'true': '-से-अंत', 'false': '', 'other': ''})} वर्ण पर डालें।";
  ...
  static String m8(toEnd) =>
      "शुरुआत से और अंत से के बीच गिनती की दिशा स्विच करना, वर्तमान में ${Intl.select(toEnd, {'true': 'अंत', 'false': 'शुरुआत', 'other': ''})} से गिनती";
  ...
  static String m12(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {'true': 'चयनित', 'false': 'अचयनित', 'other': ''})} ${Intl.select(entityType, {'File': 'फ़ाइल', 'Directory': 'फ़ोल्डर', 'Link': 'लिंक', 'other': 'फ़ाइल सिस्टम इकाई'})}, फ़ाइल नाम ${filename} है, ";
  ...
  static String m15(
    ...
    iTwo,
      ...
      "काटें: ${Intl.select(keepType, {'true': 'केवल रखें', 'false': 'हटाएं', 'other': ''})} ${iOne}${Intl.select(iTwoOrdinal, {'o1': 'वें', 'o2': 'वें', 'o3': 'वें', 'other': 'वें'})}${Intl.select(iOneToEnd, {'true': '-से-अंत', 'false': '', 'other': ''})} वर्ण और ${iTwo}${Intl.select(iOneOrdinal, {'o1': 'वें', 'o2': 'वें', 'o3': 'वें', 'other': 'वें'})}${Intl.select(iTwoToEnd, {'true': '-से-अंत', 'false': '', 'other': ''})} के बीच के वर्ण।";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "fileModifyDate": MessageLookupByLibrary.simpleMessage(
      "फ़ाइल संशोधित करने की तारीख",
    ),
    "fileModifyTime": MessageLookupByLibrary.simpleMessage(
      "फ़ाइल संशोधित करने का समय",
    ),
    "fileNotExist": MessageLookupByLibrary.simpleMessage("फ़ाइल मौजूद नहीं है"),
    ...
    "insertToString": m4,
    "insertedText": MessageLookupByLibrary.simpleMessage("डालने के लिए पाठ"),
    ...
    "musicDiscNumber": MessageLookupByLibrary.simpleMessage("डिस्क की स्थिति"),
    "musicGenres": MessageLookupByLibrary.simpleMessage("संगीत का कला प्रकार"),
    "musicTrackArtist": MessageLookupByLibrary.simpleMessage(
      "ट्रैक में प्रदर्शन करने वाले कलाकारों के नाम",
    ),
    "musicTrackDuration": MessageLookupByLibrary.simpleMessage("ट्रैक की अवधि"),
    "musicTrackName": MessageLookupByLibrary.simpleMessage("ट्रैक का नाम"),
    "musicTrackNumber": MessageLookupByLibrary.simpleMessage(
      "एल्बम में ट्रैक की स्थिति",
    ),
    "musicWriter": MessageLookupByLibrary.simpleMessage("ट्रैक का लेखक"),
    "musicYear": MessageLookupByLibrary.simpleMessage("ट्रैक का प्रकाशन वर्ष"),
    "newName": MessageLookupByLibrary.simpleMessage("नया नाम"),
    ...
    "permissionTitle": MessageLookupByLibrary.simpleMessage(
      "बाहरी संग्रहण अनुमति",
    ),
    "photoAltitude": MessageLookupByLibrary.simpleMessage(
      "exif से फोटो GPS ऊंचाई",
    ),
    "photoAperture": MessageLookupByLibrary.simpleMessage("exif से एपर्चर मान"),
    "photoCamName": MessageLookupByLibrary.simpleMessage("exif से कैमरा नाम"),
    "photoCopyright": MessageLookupByLibrary.simpleMessage(
      "exif से कॉपीराइट धारक नाम",
    ),
    "photoDate": MessageLookupByLibrary.simpleMessage(
      "exif से फोटोग्राफी की तारीख",
    ),
    ...
    "rearrange": MessageLookupByLibrary.simpleMessage("पुनर्व्यवस्थित करें"),
