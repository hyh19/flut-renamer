...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "הכנס \"${insert}\" בתו ${insertIndex}${Intl.select(ordinal, {
            'o1': 'ה',
            'o2': 'ה',
            'o3': 'ה',
            'other': 'ה',
  ...
  static String m8(toEnd) =>
      "מעבר בין כיוון ספירה מההתחלה ומהסוף, כרגע סופר מ-${Intl.select(toEnd, {
            'true': 'הסוף',
            'false': 'ההתחלה',
            'other': '',
          })}";
  ...
  static String m12(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {
            ...
            'Directory': 'תיקייה',
            'Link': 'קישור',
            'other': 'יישות מערכת קבצים',
          })}, שם הקובץ הוא ${filename}, ";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
          iOne, iTwo) =>
      "קיצוץ: ${Intl.select(keepType, {
            'true': 'שמור רק',
            'false': 'הסר',
            'other': '',
          })} תווים בין ${iOne}${Intl.select(iTwoOrdinal, {
            'o1': 'ה',
            'o2': 'ה',
            'o3': 'ה',
            'other': 'ה',
            ...
            'false': '',
            'other': '',
          })} תו ל-${iTwo}${Intl.select(iOneOrdinal, {
            'o1': 'ה',
            'o2': 'ה',
            'o3': 'ה',
            'other': 'ה',
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("הוסף תגית מטא-נתונים"),
        ...
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("הוראות שינוי שם"),
        "aiRenameRulePreview": m1,
        "aiRenameSnackbarEmptyRequirements":
            MessageLookupByLibrary.simpleMessage("הכנס הוראות שינוי שם"),
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("לא נבחרו קבצים"),
        ...
        "androidRemindTitle":
            MessageLookupByLibrary.simpleMessage("שינוי שם תיקייה"),
        ...
        "appName":
            MessageLookupByLibrary.simpleMessage("עוזר שינוי שם קבצים אצווה"),
        ...
        "caseSensitive":
            MessageLookupByLibrary.simpleMessage("רגיש לאותיות גדולות/קטנות"),
        "collapseOptions":
            MessageLookupByLibrary.simpleMessage("צמצם אפשרויות"),
        "colorPicker": MessageLookupByLibrary.simpleMessage("בוחר צבעים"),
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("העתק מחסנית שגיאות"),
        ...
        "doNotRemindAgain":
            MessageLookupByLibrary.simpleMessage("אישור. אל תזכיר לי שוב."),
        ...
        "dropToAdd":
            MessageLookupByLibrary.simpleMessage("שחרר כדי להוסיף קבצים."),
        ...
        "exitTitle":
            MessageLookupByLibrary.simpleMessage("לא ניתן לגשת לאחסון חיצוני"),
        ...
        "fileCreateDate":
            MessageLookupByLibrary.simpleMessage("תאריך יצירת הקובץ"),
        "fileCreateTime":
            MessageLookupByLibrary.simpleMessage("שעת יצירת הקובץ"),
        "fileManagerBackButton": MessageLookupByLibrary.simpleMessage("חזור"),
        "fileManagerSaveButton":
            MessageLookupByLibrary.simpleMessage("הוסף בחירות לרשימה"),
        "fileManagerSortButton":
            MessageLookupByLibrary.simpleMessage("מיין לפי"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("בחר אחסון"),
        "fileModifyDate":
            MessageLookupByLibrary.simpleMessage("תאריך שינוי הקובץ"),
        "fileModifyTime":
            MessageLookupByLibrary.simpleMessage("שעת שינוי הקובץ"),
        ...
        "insertBeforeIndex":
            MessageLookupByLibrary.simpleMessage("הכנס לפני אינדקס"),
        ...
        "iosRemindTitle":
            MessageLookupByLibrary.simpleMessage("אודות בחירת קבצים ב-iOS"),
        "isRegex": MessageLookupByLibrary.simpleMessage("הוא regex"),
        "keepCharacters":
            MessageLookupByLibrary.simpleMessage("שמור תווים ביניהם"),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("ביצוע אחר שפת המערכת"),
        ...
        "metadataTags":
            MessageLookupByLibrary.simpleMessage("תגיות מטא-נתונים"),
        "mk": MessageLookupByLibrary.simpleMessage("מקדונית"),
        "mn": MessageLookupByLibrary.simpleMessage("מונגולית"),
        "musicAlbumArtist":
            MessageLookupByLibrary.simpleMessage("שם האמן של האלבום"),
        "musicAlbumLength":
            MessageLookupByLibrary.simpleMessage("מספר השירים באלבום"),
        ...
        "musicGenres":
            MessageLookupByLibrary.simpleMessage("סוג האמנות של המוזיקה"),
        "musicTrackArtist":
            MessageLookupByLibrary.simpleMessage("שמות האמנים המבצעים בשיר"),
        ...
        "permissionTitle":
            MessageLookupByLibrary.simpleMessage("הרשאה לאחסון חיצוני"),
        "photoAltitude":
            MessageLookupByLibrary.simpleMessage("גובה GPS של התמונה מ-exif"),
        "photoAperture":
            MessageLookupByLibrary.simpleMessage("ערך הצמצם מ-exif"),
        "photoCamName":
            MessageLookupByLibrary.simpleMessage("שם המצלמה מ-exif"),
        ...
        "photoFocalLength":
            MessageLookupByLibrary.simpleMessage("אורך המוקד מ-exif"),
        ...
        "photoLensName":
            MessageLookupByLibrary.simpleMessage("שם העדשה מ-exif"),
        "photoLongitude": MessageLookupByLibrary.simpleMessage(
            "קו אורך GPS של התמונה מ-exif"),
        "photoPhotographer":
            MessageLookupByLibrary.simpleMessage("שם הצלם מ-exif"),
        "photoShutter":
            MessageLookupByLibrary.simpleMessage("מהירות התריס מ-exif"),
        ...
        "ratingGitHub":
            MessageLookupByLibrary.simpleMessage("סמן אותה בכוכב ב-GitHub"),
        "ratingStore":
            MessageLookupByLibrary.simpleMessage("דרג את האפליקציה בחנות"),
        "ratingTitle":
            MessageLookupByLibrary.simpleMessage("דרג את האפליקציה שלנו"),
        "rearrange": MessageLookupByLibrary.simpleMessage("סדר מחדש"),
        "rearrangeDelimiter":
            MessageLookupByLibrary.simpleMessage("מפריד סידור מחדש"),
        "rearrangeOrderHint":
            MessageLookupByLibrary.simpleMessage("מספרים מופרדים בפסיק"),
        "rearrangeOrderLabel":
            MessageLookupByLibrary.simpleMessage("סדר סידור מחדש"),
        ...
        "removeCharacters":
            MessageLookupByLibrary.simpleMessage("הסר תווים ביניהם"),
        "removeFile": MessageLookupByLibrary.simpleMessage("הסר קובץ"),
        "removeRenamed":
            MessageLookupByLibrary.simpleMessage("הסר קבצים ששמם שונה"),
        ...
        "showHiddenFiles":
            MessageLookupByLibrary.simpleMessage("הצג קבצים מוסתרים"),
        ...
        "themeModeDark": MessageLookupByLibrary.simpleMessage("מצב כהה"),
        "themeModeLight": MessageLookupByLibrary.simpleMessage("מצב בהיר"),
        "themeModeSystem":
            MessageLookupByLibrary.simpleMessage("עקוב אחר המערכת"),
        ...
        "transliterateCyrillic2Latin":
            MessageLookupByLibrary.simpleMessage("תווים קיריליים ללטיניים"),
        "transliterateLatin2Cyrillic":
            MessageLookupByLibrary.simpleMessage("תווים לטיניים לקיריליים"),
        "transliterateLower":
            MessageLookupByLibrary.simpleMessage("תווים לטיניים לאותיות קטנות"),
        "transliteratePinyin":
            MessageLookupByLibrary.simpleMessage("תווים סיניים ל-pinyin"),
        "transliterateSimplified":
            MessageLookupByLibrary.simpleMessage("תווים סיניים לסינית מפושטת"),
        "transliterateToString": m13,
        "transliterateToStringCyrillic": m14,
        "transliterateTraditional":
            MessageLookupByLibrary.simpleMessage("תווים סיניים לסינית מסורתית"),
