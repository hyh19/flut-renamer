...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "Sisipkan \"${insert}\" pada karakter ${insertIndex}${Intl.select(ordinal, {
            'o1': 'ke-',
            'o2': 'ke-',
            'o3': 'ke-',
            'other': 'ke-',
  ...
  static String m8(toEnd) =>
      "Mengalihkan arah penghitungan antara dari awal dan dari akhir, saat ini menghitung dari ${Intl.select(toEnd, {
            'true': 'akhir',
            'false': 'awal',
            'other': '',
          })}";
  ...
  static String m12(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {
            ...
            'Directory': 'Folder',
            'Link': 'Tautan',
            'other': 'Entitas sistem file',
          })}, nama file adalah ${filename}, ";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
      ...
      "Potong: ${Intl.select(keepType, {
            'true': 'pertahankan hanya',
            'false': 'hapus',
            'other': '',
          })} karakter antara karakter ${iOne}${Intl.select(iTwoOrdinal, {
            'o1': 'ke-',
            'o2': 'ke-',
            'o3': 'ke-',
            'other': 'ke-',
            ...
            'false': '',
            'other': '',
          })} dan ${iTwo}${Intl.select(iOneOrdinal, {
            'o1': 'ke-',
            'o2': 'ke-',
            'o3': 'ke-',
            'other': 'ke-',
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("Tambahkan tag metadata"),
        ...
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("Instruksi penggantian nama"),
        ...
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("Tidak ada file yang dipilih"),
        ...
        "androidRemindTitle":
            MessageLookupByLibrary.simpleMessage("Ganti nama direktori"),
        ...
        "caseSensitive":
            MessageLookupByLibrary.simpleMessage("Peka huruf besar/kecil"),
        ...
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("Salin tumpukan kesalahan"),
        ...
        "dropToAdd":
            MessageLookupByLibrary.simpleMessage("Lepas untuk menambah file."),
        "errorDetails":
            MessageLookupByLibrary.simpleMessage("Detail kesalahan"),
        ...
        "fileCreateDate":
            MessageLookupByLibrary.simpleMessage("Tanggal pembuatan file"),
        "fileCreateTime":
            MessageLookupByLibrary.simpleMessage("Waktu pembuatan file"),
        "fileManagerBackButton":
            MessageLookupByLibrary.simpleMessage("Kembali"),
        "fileManagerSaveButton":
            MessageLookupByLibrary.simpleMessage("Tambahkan pilihan ke daftar"),
        "fileManagerSortButton":
            MessageLookupByLibrary.simpleMessage("Urutkan berdasarkan"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("Pilih penyimpanan"),
        "fileModifyDate":
            MessageLookupByLibrary.simpleMessage("Tanggal modifikasi file"),
        "fileModifyTime":
            MessageLookupByLibrary.simpleMessage("Waktu modifikasi file"),
        ...
        "ignoreExtension":
            MessageLookupByLibrary.simpleMessage("Abaikan Ekstensi"),
        "increment": MessageLookupByLibrary.simpleMessage("Kenaikan"),
        "incrementToString": m3,
        "indexIncrementalStep":
            MessageLookupByLibrary.simpleMessage("Langkah kenaikan indeks"),
        "indexOne":
            MessageLookupByLibrary.simpleMessage("Indeks karakter pertama"),
        "indexTwo":
            MessageLookupByLibrary.simpleMessage("Indeks karakter kedua"),
        "insert": MessageLookupByLibrary.simpleMessage("Sisipkan"),
        "insertBeforeIndex":
            MessageLookupByLibrary.simpleMessage("Sisipkan sebelum indeks"),
        "insertIndex":
            MessageLookupByLibrary.simpleMessage("Indeks penyisipan"),
        "insertTagInsideAnother": MessageLookupByLibrary.simpleMessage(
            "Jangan menyisipkan tag di dalam tag lain."),
        "insertToString": m4,
        "insertedText":
            MessageLookupByLibrary.simpleMessage("Teks yang akan disisipkan"),
        ...
        "iosRemindTitle":
            MessageLookupByLibrary.simpleMessage("Tentang memilih file di iOS"),
        ...
        "musicAlbumLength":
            MessageLookupByLibrary.simpleMessage("Jumlah lagu dalam album"),
        ...
        "musicTrackDuration":
            MessageLookupByLibrary.simpleMessage("Durasi lagu"),
        "musicTrackName": MessageLookupByLibrary.simpleMessage("Nama lagu"),
        "musicTrackNumber":
            MessageLookupByLibrary.simpleMessage("Posisi lagu dalam album"),
        "musicWriter": MessageLookupByLibrary.simpleMessage("Penulis lagu"),
        "musicYear":
            MessageLookupByLibrary.simpleMessage("Tahun publikasi lagu"),
        ...
        "omitDash":
            MessageLookupByLibrary.simpleMessage("Hilangkan tanda hubung"),
        "onlySelected":
        ...
        "permissionTitle":
            MessageLookupByLibrary.simpleMessage("Izin penyimpanan eksternal"),
        ...
        "photoLatitude":
            MessageLookupByLibrary.simpleMessage("Lintang GPS foto dari exif"),
        "photoLensName":
            MessageLookupByLibrary.simpleMessage("Nama lensa dari exif"),
        "photoLongitude":
            MessageLookupByLibrary.simpleMessage("Bujur GPS foto dari exif"),
        "photoPhotographer":
            MessageLookupByLibrary.simpleMessage("Nama fotografer dari exif"),
        "photoShutter":
            MessageLookupByLibrary.simpleMessage("Kecepatan rana dari exif"),
        "photoTime":
            MessageLookupByLibrary.simpleMessage("Waktu pemotretan dari exif"),
        ...
        "ratingGitHub":
            MessageLookupByLibrary.simpleMessage("Beri bintang di GitHub"),
        "ratingStore": MessageLookupByLibrary.simpleMessage(
            "Beri rating aplikasi di toko"),
        "ratingTitle":
            MessageLookupByLibrary.simpleMessage("Beri Rating Aplikasi Kami"),
        "rearrange": MessageLookupByLibrary.simpleMessage("Susun ulang"),
        "rearrangeDelimiter":
            MessageLookupByLibrary.simpleMessage("Pembatas susun ulang"),
        "rearrangeOrderHint": MessageLookupByLibrary.simpleMessage(
            "angka dipisahkan dengan koma"),
        "rearrangeOrderLabel":
            MessageLookupByLibrary.simpleMessage("Urutan susun ulang"),
        ...
        "renameFailed":
            MessageLookupByLibrary.simpleMessage("Penggantian nama gagal"),
        ...
        "showHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Tampilkan file tersembunyi"),
        ...
        "transliterateCyrillic2Latin":
            MessageLookupByLibrary.simpleMessage("Karakter Cyrillic ke Latin"),
        "transliterateLatin2Cyrillic":
            MessageLookupByLibrary.simpleMessage("Karakter Latin ke Cyrillic"),
        "transliterateLower": MessageLookupByLibrary.simpleMessage(
            "Karakter Latin ke huruf kecil"),
        "transliteratePinyin":
            MessageLookupByLibrary.simpleMessage("Karakter Cina ke pinyin"),
