...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(error) => "AI 重命名失败：${error}";

  static String m1(requirements) => "AI 重命名：${requirements}";

  static String m2(count) => "AI 重命名规则已创建，将重命名 ${count} 个文件";

  static String m3(prefix) => "递增：${prefix}索引";
  ...
  static String m5(delimiter, order) => "重排：分隔符：${delimiter}，顺序：${order}。";

  static String m6(targetString) => "删除：“${targetString}”";

  static String m7(targetString, replacementString) =>
      "替换：将“${targetString}”替换为“${replacementString}”。";

  static String m8(toEnd) => "切换计数方式为从开头计数或从末尾计数，当前从${Intl.select(toEnd, {
            'true': '末尾',
            'false': '开头',
            'other': '',
          })}计数。";

  static String m9(value) => "这是一个下拉按钮，现在选中的是“${value}”，双击以打开下拉按钮并选取另一个值。";

  static String m10(last) => "上次修改时间是${last}。";

  static String m11(last, size) => "上次修改时间是${last}，文件大小是${size}。";
  ...
  static String m13(type) => "转写：${type}。";

  static String m14(langName, type) => "转写：将${langName}${type}。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "aboutContent": MessageLookupByLibrary.simpleMessage(
            "此应用旨在帮助用户重命名文件。它使用 Flutter 框架开发，因此也适用于其他操作系统。它是完全开源的，可以进行审查和贡献。"),
        ...
        "aiRenameError": m0,
        "aiRenameLoading":
            MessageLookupByLibrary.simpleMessage("AI 正在分析您的需求，请稍候..."),
        "aiRenameRequirementsHint":
            MessageLookupByLibrary.simpleMessage("请描述您希望如何重命名这些文件。"),
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("重命名需求描述"),
        "aiRenameRulePreview": m1,
        "aiRenameSnackbarEmptyRequirements":
            MessageLookupByLibrary.simpleMessage("请输入重命名需求描述"),
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("没有选中的文件"),
        "aiRenameSubmit": MessageLookupByLibrary.simpleMessage("提交"),
        "aiRenameSuccess": m2,
        "aiRenameTitle": MessageLookupByLibrary.simpleMessage("AI 重命名"),
        "androidRemindContent": MessageLookupByLibrary.simpleMessage(
            "使用文件批量重命名助手，您不仅可以重命名文件，还可以重命名目录。长按目录将其选中，然后在左上角下拉按钮中选择\"文件和目录\"即可启用目录重命名功能。出于安全考虑，某些系统保留目录不可选。"),
        ...
        "appName": MessageLookupByLibrary.simpleMessage("文件批量重命名助手"),
        ...
        "descriptionRemove":
            MessageLookupByLibrary.simpleMessage("从文件名中删除指定的文本。"),
        "descriptionReplace":
            MessageLookupByLibrary.simpleMessage("用给定的替换文本替换指定的文本。"),
        ...
        "dragNotSupported":
            MessageLookupByLibrary.simpleMessage("由于系统安全限制，不支持从此应用拖放文件。"),
        ...
        "iosRemindContent": MessageLookupByLibrary.simpleMessage(
            "要在 iOS 上选取文件，首先选择一个包含您的文件的文件夹。然后，在选定的文件夹中，选择您要重命名的文件。由于 iOS 的限制，我们必须采取这两个步骤，这可以确保安全的文件访问。让我们开始吧！"),
        "iosRemindTitle": MessageLookupByLibrary.simpleMessage("关于在 iOS 上选取文件"),
        ...
        "languageEnglishOnly": MessageLookupByLibrary.simpleMessage("英语"),
        "languageFollowSystem": MessageLookupByLibrary.simpleMessage("跟随系统语言"),
        "limit": MessageLookupByLibrary.simpleMessage("次数"),
        "lowercaseAppName": MessageLookupByLibrary.simpleMessage("文件批量重命名助手"),
        ...
        "newName": MessageLookupByLibrary.simpleMessage("新文件名预览"),
        ...
        "photoAltitude":
            MessageLookupByLibrary.simpleMessage("照片 GPS 海拔（来自 EXIF）"),
        "photoAperture": MessageLookupByLibrary.simpleMessage("光圈数值（来自 EXIF）"),
        "photoCamName": MessageLookupByLibrary.simpleMessage("相机名称（来自 EXIF）"),
        "photoCopyright":
            MessageLookupByLibrary.simpleMessage("版权所有者姓名（来自 EXIF）"),
        "photoDate": MessageLookupByLibrary.simpleMessage("照片拍摄日期（来自 EXIF）"),
        "photoFocalLength": MessageLookupByLibrary.simpleMessage("焦距（来自 EXIF）"),
        "photoISO": MessageLookupByLibrary.simpleMessage("ISO 数值（来自 EXIF）"),
        "photoLatitude":
            MessageLookupByLibrary.simpleMessage("照片 GPS 纬度（来自 EXIF）"),
        "photoLensName": MessageLookupByLibrary.simpleMessage("镜头名称（来自 EXIF）"),
        "photoLongitude":
            MessageLookupByLibrary.simpleMessage("照片 GPS 经度（来自 EXIF）"),
        "photoPhotographer":
            MessageLookupByLibrary.simpleMessage("摄影师姓名（来自 EXIF）"),
        "photoShutter": MessageLookupByLibrary.simpleMessage("快门速度（来自 EXIF）"),
        "photoTime": MessageLookupByLibrary.simpleMessage("照片拍摄时间（来自 EXIF）"),
        "prefix": MessageLookupByLibrary.simpleMessage("前缀"),
        "rating": MessageLookupByLibrary.simpleMessage("应用评分"),
        "ratingContent": MessageLookupByLibrary.simpleMessage(
            "喜欢我们的应用吗？在应用商店给个好评或在 GitHub 上点赞来帮助我们成长。您的反馈对我们非常重要！感谢您的支持。"),
        "ratingGitHub": MessageLookupByLibrary.simpleMessage("给 GitHub 仓库点赞"),
        ...
        "semanticNumberWithDirection":
            MessageLookupByLibrary.simpleMessage("切换计数方式为从开头计数或从末尾计数"),
