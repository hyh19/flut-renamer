...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(error) => "AI 이름 변경 실패: ${error}";

  static String m1(requirements) => "AI 이름 변경: ${requirements}";

  static String m2(count) => "AI 이름 변경 규칙이 생성되었습니다. ${count}개의 파일 이름이 변경됩니다.";

  static String m3(prefix) => "접두사-인덱스로 증가합니다.";
  ...
  static String m5(delimiter, order) => "구분 기호: ${delimiter}, 순서: ${order}.";

  static String m6(targetString) => "\"${targetString}\"을(를) 제거합니다.";

  static String m7(targetString, replacementString) =>
      "대상 문자열을 \"${replacementString}\"(으)로 대체합니다.";

  static String m8(toEnd) => "시작과 끝 사이의 계산 방향 전환, 현재 ${Intl.select(toEnd, {
            'true': '끝',
            'false': '시작',
            'other': '',
          })}부터 계산 중";
  ...
  static String m10(last) => "마지막 수정 시간은 ${last}입니다.";

  static String m11(last, size) => "마지막 수정 시간은 ${last}이고 파일 크기는 ${size}입니다.";
  ...
  static String m13(type) => "음역: ${type}.";

  static String m14(langName, type) => "음역: ${langName} ${type}.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("이름 변경 지침"),
        "aiRenameRulePreview": m1,
        "aiRenameSnackbarEmptyRequirements":
            MessageLookupByLibrary.simpleMessage("이름 변경 지침을 입력하세요"),
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("선택된 파일이 없습니다"),
        "aiRenameSubmit": MessageLookupByLibrary.simpleMessage("제출"),
        "aiRenameSuccess": m2,
        "aiRenameTitle": MessageLookupByLibrary.simpleMessage("AI 이름 변경"),
        "androidRemindContent": MessageLookupByLibrary.simpleMessage(
            "파일 일괄 이름 변경 도우미를 사용하면 파일뿐만 아니라 디렉토리 이름도 바꿀 수 있습니다. 디렉토리를 길게 눌러 선택한 다음 왼쪽 상단의 드롭다운 버튼에서 \'파일 및 디렉토리\'를 선택하여 디렉토리 이름을 바꿀 수 있습니다. 보안상의 이유로 일부 시스템 예약 디렉토리는 선택할 수 없습니다."),
        "androidRemindTitle":
        ...
        "descriptionInsert":
            MessageLookupByLibrary.simpleMessage("지정된 위치에 제공된 텍스트를 삽입합니다."),
        "descriptionRearrange": MessageLookupByLibrary.simpleMessage(
            "파일 이름을 사용자가 지정한 구분 기호로 분할하고 제공된 순서에 따라 다시 정렬합니다."),
        "descriptionRemove":
            MessageLookupByLibrary.simpleMessage("지정된 텍스트를 파일 이름에서 제거합니다."),
        "descriptionReplace":
            MessageLookupByLibrary.simpleMessage("지정된 텍스트를 제공된 대체 텍스트로 바꿉니다."),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("시스템 언어 따르기"),
        "limit": MessageLookupByLibrary.simpleMessage("제한"),
        "lowercaseAppName":
            MessageLookupByLibrary.simpleMessage("파일 일괄 이름 변경 도우미"),
        ...
        "semanticNumberWithDirection":
            MessageLookupByLibrary.simpleMessage("처음부터와 끝부터의 계산 방향 전환"),
        ...
        "themeModeDark": MessageLookupByLibrary.simpleMessage("다크 모드"),
        "themeModeLight": MessageLookupByLibrary.simpleMessage("라이트 모드"),
        "themeModeSystem": MessageLookupByLibrary.simpleMessage("시스템 따르기"),
