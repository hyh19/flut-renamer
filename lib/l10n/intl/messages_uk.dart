...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "Вставити «${insert}» у ${insertIndex}${Intl.select(ordinal, {
            'o1': '-й',
            'o2': '-й',
            'o3': '-й',
            'other': '-й',
          })} символ${Intl.select(toEnd, {
            'true': '-з-кінця',
            'false': '',
            'other': '',
          })}.";
  ...
  static String m8(toEnd) =>
      "Перемкнути підрахунок між початком і кінцем, зараз: ${Intl.select(toEnd, {
            'true': 'з кінця',
            'false': 'з початку',
            'other': '',
          })}";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
          iOne, iTwo) =>
      "Обрізання: ${Intl.select(keepType, {
            'true': 'залишити лише',
            'false': 'видалити',
            'other': '',
          })} символи між ${iOne}${Intl.select(iTwoOrdinal, {
            'o1': '-м',
            'o2': '-м',
            'o3': '-м',
            'other': '-м',
          })} символом${Intl.select(iOneToEnd, {
            'true': '-з-кінця',
            'false': '',
            'other': '',
          })} і ${iTwo}${Intl.select(iOneOrdinal, {
            'o1': '-м',
            'o2': '-м',
            'o3': '-м',
            'other': '-м',
          })} символом${Intl.select(iTwoToEnd, {
            'true': '-з-кінця',
            'false': '',
            'other': '',
          })}.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("Додати тег метаданих"),
        ...
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("Не вибрано жодного файла"),
        "aiRenameSubmit": MessageLookupByLibrary.simpleMessage("Надіслати"),
        "aiRenameSuccess": m2,
        "aiRenameTitle":
            MessageLookupByLibrary.simpleMessage("AI-перейменування"),
        ...
        "androidRemindTitle":
            MessageLookupByLibrary.simpleMessage("Перейменування тек"),
        ...
        "appName":
            MessageLookupByLibrary.simpleMessage("Перейменування файлів"),
        ...
        "collapseOptions":
            MessageLookupByLibrary.simpleMessage("Згорнути параметри"),
        "colorPicker": MessageLookupByLibrary.simpleMessage("Палітра кольорів"),
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("Копіювати стек помилок"),
        ...
        "errorDetails":
            MessageLookupByLibrary.simpleMessage("Подробиці помилки"),
        ...
        "expandOptions":
            MessageLookupByLibrary.simpleMessage("Розгорнути параметри"),
        "fileAlreadyExists": MessageLookupByLibrary.simpleMessage(
            "Назву вже використано іншим файлом"),
        "fileCreateDate":
            MessageLookupByLibrary.simpleMessage("Дата створення"),
        ...
        "fileManagerSaveButton":
            MessageLookupByLibrary.simpleMessage("Додати обране до списку"),
        "fileManagerSortButton":
            MessageLookupByLibrary.simpleMessage("Сортувати за"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("Вибрати сховище"),
        ...
        "hideHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Сховати приховані файли"),
        "ifFileNotShown": MessageLookupByLibrary.simpleMessage(
            "Якщо файли не відображаються у списку, очистьте все й продовжуйте."),
        "ignoreExtension":
            MessageLookupByLibrary.simpleMessage("Ігнорувати розширення"),
        "increment": MessageLookupByLibrary.simpleMessage("Наростити"),
        "incrementToString": m3,
        "indexIncrementalStep":
            MessageLookupByLibrary.simpleMessage("Крок нарощування"),
        "indexOne":
            MessageLookupByLibrary.simpleMessage("Індекс першого символу"),
        "indexTwo":
            MessageLookupByLibrary.simpleMessage("Індекс другого символу"),
        "insert": MessageLookupByLibrary.simpleMessage("Вставити"),
        "insertBeforeIndex":
            MessageLookupByLibrary.simpleMessage("Вставити перед позицією"),
        ...
        "iosRemindTitle":
            MessageLookupByLibrary.simpleMessage("Як вибрати файли на iOS"),
        "isRegex":
            MessageLookupByLibrary.simpleMessage("Використовувати regex"),
        "keepCharacters":
            MessageLookupByLibrary.simpleMessage("Залишити символи між ними"),
        "language": MessageLookupByLibrary.simpleMessage("Мова: "),
        "languageEnglishOnly":
            MessageLookupByLibrary.simpleMessage("Англійська"),
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("Слідувати мові системи"),
        ...
        "musicAlbumArtist":
            MessageLookupByLibrary.simpleMessage("Ім\'я виконавця альбому"),
        "musicAlbumLength":
            MessageLookupByLibrary.simpleMessage("Кількість треків в альбомі"),
        ...
        "musicTrackArtist":
            MessageLookupByLibrary.simpleMessage("Виконавці треку"),
        "musicTrackDuration":
            MessageLookupByLibrary.simpleMessage("Тривалість треку"),
        "musicTrackName": MessageLookupByLibrary.simpleMessage("Назва треку"),
        "musicTrackNumber":
            MessageLookupByLibrary.simpleMessage("Номер треку в альбомі"),
        ...
        "permissionTitle":
            MessageLookupByLibrary.simpleMessage("Дозвіл на зовнішнє сховище"),
        "photoAltitude":
            MessageLookupByLibrary.simpleMessage("GPS-висота з EXIF"),
        "photoAperture":
            MessageLookupByLibrary.simpleMessage("Діафрагма з EXIF"),
        "photoCamName":
            MessageLookupByLibrary.simpleMessage("Назва камери з EXIF"),
        "photoCopyright":
            MessageLookupByLibrary.simpleMessage("Правовласник з EXIF"),
        "photoDate": MessageLookupByLibrary.simpleMessage("Дата знімка з EXIF"),
        "photoFocalLength":
            MessageLookupByLibrary.simpleMessage("Фокусна відстань з EXIF"),
        "photoISO": MessageLookupByLibrary.simpleMessage("ISO з EXIF"),
        "photoLatitude":
            MessageLookupByLibrary.simpleMessage("GPS-широта з EXIF"),
        "photoLensName":
            MessageLookupByLibrary.simpleMessage("Назва об\'єктива з EXIF"),
        "photoLongitude":
            MessageLookupByLibrary.simpleMessage("GPS-довгота з EXIF"),
        "photoPhotographer":
            MessageLookupByLibrary.simpleMessage("Ім\'я фотографа з EXIF"),
        ...
        "ratingGitHub":
            MessageLookupByLibrary.simpleMessage("Поставте зірку в GitHub"),
        "ratingStore":
            MessageLookupByLibrary.simpleMessage("Оцініть у магазині"),
        "ratingTitle":
            MessageLookupByLibrary.simpleMessage("Оцініть наш застосунок"),
        "rearrange": MessageLookupByLibrary.simpleMessage("Переставити"),
        "rearrangeDelimiter":
            MessageLookupByLibrary.simpleMessage("Роздільник"),
        "rearrangeOrderHint":
            MessageLookupByLibrary.simpleMessage("числа, розділені комами"),
        "rearrangeOrderLabel":
        ...
        "removeCharacters":
            MessageLookupByLibrary.simpleMessage("Вилучити символи між ними"),
        ...
        "removeRule":
            MessageLookupByLibrary.simpleMessage("Видалити це правило"),
        ...
        "renameFailed":
            MessageLookupByLibrary.simpleMessage("Не вдалося перейменувати"),
        ...
        "showHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Показати приховані файли"),
        ...
        "themeModeSystem":
            MessageLookupByLibrary.simpleMessage("Слідувати системі"),
        ...
        "transliterateCyrillic2Latin":
            MessageLookupByLibrary.simpleMessage("Кирилиця → латиниця"),
        "transliterateLatin2Cyrillic":
            MessageLookupByLibrary.simpleMessage("Латиниця → кирилиця"),
