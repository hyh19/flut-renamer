...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(error) => "AI rename failed: ${error}";

  static String m1(requirements) => "AI rename: ${requirements}";

  static String m2(count) =>
      "AI rename rule created. ${count} files will be renamed.";

  static String m3(prefix) => "Incremental renaming: ${prefix}index";
  ...
  static String m6(targetString) => "Remove \"${targetString}\"";
  ...
  static String m11(last, size) => "last modified at ${last}, sized ${size}.";
  ...
  static String m13(type) => "Transliterate: convert ${type}.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("Rename instructions"),
        "aiRenameRulePreview": m1,
        "aiRenameSnackbarEmptyRequirements":
            MessageLookupByLibrary.simpleMessage("Enter rename instructions"),
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("No files selected"),
        "aiRenameSubmit": MessageLookupByLibrary.simpleMessage("Submit"),
        "aiRenameSuccess": m2,
        "aiRenameTitle": MessageLookupByLibrary.simpleMessage("AI Rename"),
        ...
        "appName":
            MessageLookupByLibrary.simpleMessage("Batch File Rename Assistant"),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("Follow system language"),
        ...
        "newName": MessageLookupByLibrary.simpleMessage("New name preview"),
