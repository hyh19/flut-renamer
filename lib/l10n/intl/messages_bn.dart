...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m8(toEnd) =>
      "শুরু এবং শেষ থেকে গণনার দিক পরিবর্তন করা, বর্তমানে ${Intl.select(toEnd, {
            'true': 'শেষ',
            'false': 'শুরু',
            'other': '',
          })} থেকে গণনা করা হচ্ছে";
  ...
  static String m12(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {
            ...
            'Directory': 'ফোল্ডার',
            'Link': 'লিঙ্ক',
            'other': 'ফাইল সিস্টেম এনটিটি',
          })}, ফাইলের নাম হল ${filename}, ";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
      ...
      "ছাঁটাই: ${Intl.select(keepType, {
            ...
            'false': '',
            'other': '',
          })} অক্ষর এবং ${iTwo}${Intl.select(iOneOrdinal, {
            'o1': 'তম',
            'o2': 'য়',
            'o3': 'য়',
            'other': 'তম',
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("মেটাডেটা ট্যাগ যোগ করুন"),
        ...
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("নাম পরিবর্তনের নির্দেশাবলী"),
        ...
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("কোন ফাইল নির্বাচিত নেই"),
        "aiRenameSubmit": MessageLookupByLibrary.simpleMessage("জমা দিন"),
        "aiRenameSuccess": m2,
        "aiRenameTitle":
            MessageLookupByLibrary.simpleMessage("AI নাম পরিবর্তন"),
        ...
        "collapseOptions":
            MessageLookupByLibrary.simpleMessage("বিকল্পগুলি সংকুচিত করুন"),
        "colorPicker": MessageLookupByLibrary.simpleMessage("রঙ নির্বাচক"),
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("ত্রুটি স্ট্যাক কপি করুন"),
        ...
        "dropToAdd":
            MessageLookupByLibrary.simpleMessage("ফাইল যোগ করতে ছেড়ে দিন।"),
        ...
        "expandOptions":
            MessageLookupByLibrary.simpleMessage("বিকল্পগুলি প্রসারিত করুন"),
        "fileAlreadyExists": MessageLookupByLibrary.simpleMessage(
            "ফাইলের নাম ইতিমধ্যে অন্য একটি ফাইল দ্বারা ব্যবহৃত হচ্ছে"),
        "fileCreateDate":
            MessageLookupByLibrary.simpleMessage("ফাইল তৈরির তারিখ"),
        "fileCreateTime":
            MessageLookupByLibrary.simpleMessage("ফাইল তৈরির সময়"),
        "fileManagerBackButton": MessageLookupByLibrary.simpleMessage("পিছনে"),
        "fileManagerSaveButton":
            MessageLookupByLibrary.simpleMessage("তালিকায় নির্বাচন যোগ করুন"),
        "fileManagerSortButton":
            MessageLookupByLibrary.simpleMessage("দ্বারা সাজান"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("স্টোরেজ নির্বাচন করুন"),
        "fileModifyDate":
            MessageLookupByLibrary.simpleMessage("ফাইল পরিবর্তনের তারিখ"),
        "fileModifyTime":
            MessageLookupByLibrary.simpleMessage("ফাইল পরিবর্তনের সময়"),
        "fileNotExist":
            MessageLookupByLibrary.simpleMessage("ফাইল বিদ্যমান নেই"),
        ...
        "hideHiddenFiles":
            MessageLookupByLibrary.simpleMessage("লুকানো ফাইল লুকান"),
        ...
        "ignoreExtension":
            MessageLookupByLibrary.simpleMessage("এক্সটেনশন উপেক্ষা করুন"),
        "increment": MessageLookupByLibrary.simpleMessage("বৃদ্ধি"),
        "incrementToString": m3,
        "indexIncrementalStep":
            MessageLookupByLibrary.simpleMessage("সূচক বৃদ্ধির ধাপ"),
        "indexOne": MessageLookupByLibrary.simpleMessage("প্রথম অক্ষরের সূচক"),
        "indexTwo":
            MessageLookupByLibrary.simpleMessage("দ্বিতীয় অক্ষরের সূচক"),
        "insert": MessageLookupByLibrary.simpleMessage("সন্নিবেশ"),
        "insertBeforeIndex":
            MessageLookupByLibrary.simpleMessage("সূচকের আগে সন্নিবেশ"),
        ...
        "insertToString": m4,
        "insertedText":
            MessageLookupByLibrary.simpleMessage("সন্নিবেশ করার পাঠ্য"),
        ...
        "keepCharacters":
            MessageLookupByLibrary.simpleMessage("তাদের মধ্যে অক্ষর রাখুন"),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("সিস্টেম ভাষা অনুসরণ করুন"),
        ...
        "musicAlbumArtist":
            MessageLookupByLibrary.simpleMessage("অ্যালবাম শিল্পীর নাম"),
        "musicAlbumLength":
            MessageLookupByLibrary.simpleMessage("অ্যালবামে ট্র্যাকের সংখ্যা"),
        "musicAlbumName":
            MessageLookupByLibrary.simpleMessage("অ্যালবামের নাম"),
        "musicAuthor": MessageLookupByLibrary.simpleMessage("ট্র্যাকের লেখক"),
        "musicDiscNumber":
            MessageLookupByLibrary.simpleMessage("ডিস্কের অবস্থান"),
        "musicGenres":
            MessageLookupByLibrary.simpleMessage("সঙ্গীতের শিল্পের ধরন"),
        "musicTrackArtist": MessageLookupByLibrary.simpleMessage(
            "ট্র্যাকে পারফরম্যান্স করা শিল্পীদের নাম"),
        "musicTrackDuration":
            MessageLookupByLibrary.simpleMessage("ট্র্যাকের সময়কাল"),
        "musicTrackName": MessageLookupByLibrary.simpleMessage("ট্র্যাকের নাম"),
        "musicTrackNumber":
            MessageLookupByLibrary.simpleMessage("অ্যালবামে ট্র্যাকের অবস্থান"),
        "musicWriter": MessageLookupByLibrary.simpleMessage("ট্র্যাকের লেখক"),
        "musicYear":
            MessageLookupByLibrary.simpleMessage("ট্র্যাক প্রকাশের বছর"),
        ...
        "onlySelected":
            MessageLookupByLibrary.simpleMessage("শুধুমাত্র নির্বাচিত"),
        ...
        "photoAltitude":
            MessageLookupByLibrary.simpleMessage("exif থেকে ফটো GPS-এর উচ্চতা"),
        "photoAperture":
            MessageLookupByLibrary.simpleMessage("exif থেকে অ্যাপারচার মান"),
        "photoCamName":
            MessageLookupByLibrary.simpleMessage("exif থেকে ক্যামেরার নাম"),
        "photoCopyright": MessageLookupByLibrary.simpleMessage(
            "exif থেকে কপিরাইট ধারকের নাম"),
        "photoDate":
            MessageLookupByLibrary.simpleMessage("exif থেকে ফটোগ্রাফির তারিখ"),
        "photoFocalLength":
            MessageLookupByLibrary.simpleMessage("exif থেকে ফোকাল দৈর্ঘ্য"),
        ...
        "photoLensName":
            MessageLookupByLibrary.simpleMessage("exif থেকে লেন্সের নাম"),
        "photoLongitude": MessageLookupByLibrary.simpleMessage(
            "exif থেকে ফটো GPS-এর দ্রাঘিমাংশ"),
        "photoPhotographer":
            MessageLookupByLibrary.simpleMessage("exif থেকে ফটোগ্রাফারের নাম"),
        "photoShutter":
            MessageLookupByLibrary.simpleMessage("exif থেকে শাটার গতি"),
        "photoTime":
            MessageLookupByLibrary.simpleMessage("exif থেকে ফটোগ্রাফির সময়"),
        ...
        "ratingGitHub":
            MessageLookupByLibrary.simpleMessage("GitHub-এ এটিকে স্টার করুন"),
        "ratingStore":
            MessageLookupByLibrary.simpleMessage("স্টোরে অ্যাপ রেট করুন"),
        "ratingTitle":
            MessageLookupByLibrary.simpleMessage("আমাদের অ্যাপ রেট করুন"),
        "rearrange": MessageLookupByLibrary.simpleMessage("পুনর্বিন্যাস"),
        "rearrangeDelimiter":
            MessageLookupByLibrary.simpleMessage("পুনর্বিন্যাস বিভাজক"),
        "rearrangeOrderHint":
            MessageLookupByLibrary.simpleMessage("কমা দিয়ে বিভক্ত সংখ্যা"),
        "rearrangeOrderLabel":
            MessageLookupByLibrary.simpleMessage("পুনর্বিন্যাস ক্রম"),
        ...
        "removeCharacters":
            MessageLookupByLibrary.simpleMessage("তাদের মধ্যে অক্ষর সরান"),
        "removeFile": MessageLookupByLibrary.simpleMessage("ফাইল সরান"),
        "removeRenamed":
            MessageLookupByLibrary.simpleMessage("নাম পরিবর্তিত ফাইলগুলি সরান"),
        ...
        "renameFailed":
            MessageLookupByLibrary.simpleMessage("নাম পরিবর্তন ব্যর্থ"),
        ...
        "showHiddenFiles":
            MessageLookupByLibrary.simpleMessage("লুকানো ফাইল দেখান"),
        ...
        "themeModeSystem":
            MessageLookupByLibrary.simpleMessage("সিস্টেম অনুসরণ করুন"),
        ...
        "transliterateCyrillic2Latin":
            MessageLookupByLibrary.simpleMessage("সিরিলিক অক্ষর ল্যাটিনে"),
        "transliterateLatin2Cyrillic":
            MessageLookupByLibrary.simpleMessage("ল্যাটিন অক্ষর সিরিলিকে"),
        "transliterateLower": MessageLookupByLibrary.simpleMessage(
            "ল্যাটিন অক্ষর ছোট হাতের অক্ষরে"),
        "transliteratePinyin":
            MessageLookupByLibrary.simpleMessage("চীনা অক্ষর পিনইন-এ"),
