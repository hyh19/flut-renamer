...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "Infoga \"${insert}\" vid ${insertIndex}${Intl.select(ordinal, {
            'o1': ':a',
            'o2': ':a',
            'o3': ':e',
            'other': ':e',
  ...
  static String m8(toEnd) =>
      "Växla räkningsriktning mellan från början och från slutet, räknar för närvarande från ${Intl.select(toEnd, {
            'true': 'slutet',
            'false': 'början',
            'other': '',
          })}";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
          iOne, iTwo) =>
      "Klipp av: ${Intl.select(keepType, {
            'true': 'behåll endast',
            'false': 'ta bort',
            'other': '',
          })} tecken mellan ${iOne}${Intl.select(iTwoOrdinal, {
            'o1': ':a',
            'o2': ':a',
            'o3': ':e',
            'other': ':e',
            ...
            'false': '',
            'other': '',
          })} tecknet och ${iTwo}${Intl.select(iOneOrdinal, {
            'o1': ':a',
            'o2': ':a',
            'o3': ':e',
            'other': ':e',
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("Lägg till metadatatagg"),
        ...
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("Namnbytestruktioner"),
        "aiRenameRulePreview": m1,
        "aiRenameSnackbarEmptyRequirements":
            MessageLookupByLibrary.simpleMessage("Ange namnbytestruktioner"),
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("Inga filer valda"),
        ...
        "androidRemindContent": MessageLookupByLibrary.simpleMessage(
            "Med Batch-filnamnbyte Assistent kan du byta namn på inte bara filer utan också kataloger. Tryck länge på en katalog för att välja den och välj sedan \'Filer & Kataloger\' från rullgardinsknappen i övre vänstra hörnet för att aktivera katalognamnsbyte. Av säkerhetsskäl är vissa systemreserverade kataloger inte valbara."),
        "androidRemindTitle":
            MessageLookupByLibrary.simpleMessage("Byt namn på katalog"),
        ...
        "appName":
            MessageLookupByLibrary.simpleMessage("Batch-filnamnbyte Assistent"),
        "bg": MessageLookupByLibrary.simpleMessage("Bulgariska"),
        "cancel": MessageLookupByLibrary.simpleMessage("Avbryt"),
        "cancelAll": MessageLookupByLibrary.simpleMessage("Avbryt Allt"),
        "caseSensitive":
            MessageLookupByLibrary.simpleMessage("Skiftlägeskänslig"),
        "collapseOptions":
            MessageLookupByLibrary.simpleMessage("Dölj alternativ"),
        "colorPicker": MessageLookupByLibrary.simpleMessage("Färgväljare"),
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("Kopiera felstack"),
        ...
        "doNotRemindAgain":
            MessageLookupByLibrary.simpleMessage("OK. Påminn mig inte igen."),
        ...
        "expandOptions":
            MessageLookupByLibrary.simpleMessage("Expandera alternativ"),
        "fileAlreadyExists": MessageLookupByLibrary.simpleMessage(
            "Filnamnet används redan av en annan fil"),
        "fileCreateDate":
            MessageLookupByLibrary.simpleMessage("Skapandedatum för fil"),
        "fileCreateTime":
            MessageLookupByLibrary.simpleMessage("Skapandetid för fil"),
        "fileManagerBackButton":
            MessageLookupByLibrary.simpleMessage("Tillbaka"),
        "fileManagerSaveButton":
            MessageLookupByLibrary.simpleMessage("Lägg till val till listan"),
        "fileManagerSortButton":
            MessageLookupByLibrary.simpleMessage("Sortera efter"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("Välj lagring"),
        "fileModifyDate":
            MessageLookupByLibrary.simpleMessage("Ändringsdatum för fil"),
        "fileModifyTime":
            MessageLookupByLibrary.simpleMessage("Ändringstid för fil"),
        "fileNotExist":
            MessageLookupByLibrary.simpleMessage("Filen finns inte"),
        ...
        "insertBeforeIndex":
            MessageLookupByLibrary.simpleMessage("Infoga före index"),
        ...
        "iosRemindTitle":
            MessageLookupByLibrary.simpleMessage("Om att välja filer på iOS"),
        "isRegex": MessageLookupByLibrary.simpleMessage("Är regex"),
        "keepCharacters":
            MessageLookupByLibrary.simpleMessage("Behåll tecken mellan dem"),
        "language": MessageLookupByLibrary.simpleMessage("Språk: "),
        "languageEnglishOnly": MessageLookupByLibrary.simpleMessage("Engelska"),
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("Följ systemets språk"),
        ...
        "musicAlbumArtist":
            MessageLookupByLibrary.simpleMessage("Albumartistens namn"),
        "musicAlbumLength":
            MessageLookupByLibrary.simpleMessage("Antal spår i albumet"),
        "musicAlbumName": MessageLookupByLibrary.simpleMessage("Albumets namn"),
        "musicAuthor":
            MessageLookupByLibrary.simpleMessage("Spårets författare"),
        "musicDiscNumber":
            MessageLookupByLibrary.simpleMessage("Skivans position"),
        "musicGenres":
            MessageLookupByLibrary.simpleMessage("Konsttyp för musiken"),
        "musicTrackArtist": MessageLookupByLibrary.simpleMessage(
            "Namn på artister som framför i spåret"),
        "musicTrackDuration":
            MessageLookupByLibrary.simpleMessage("Spårets varaktighet"),
        "musicTrackName": MessageLookupByLibrary.simpleMessage("Spårets namn"),
        "musicTrackNumber":
            MessageLookupByLibrary.simpleMessage("Spårets position i albumet"),
        "musicWriter":
            MessageLookupByLibrary.simpleMessage("Spårets författare"),
        "musicYear":
            MessageLookupByLibrary.simpleMessage("Publiceringsår för spåret"),
        "newName": MessageLookupByLibrary.simpleMessage(
            "Förhandsvisning av nytt namn"),
        "noSysDir": MessageLookupByLibrary.simpleMessage(
            "Byt inte namn på en systemreserverad katalog."),
        "ok": MessageLookupByLibrary.simpleMessage("OK"),
        "omitDash":
            MessageLookupByLibrary.simpleMessage("Utelämna bindestreck"),
        ...
        "photoAltitude":
            MessageLookupByLibrary.simpleMessage("Höjd för foto GPS från exif"),
        "photoAperture":
            MessageLookupByLibrary.simpleMessage("Bländarvärde från exif"),
        "photoCamName":
            MessageLookupByLibrary.simpleMessage("Kameranamn från exif"),
        ...
        "photoFocalLength":
            MessageLookupByLibrary.simpleMessage("Brännvidd från exif"),
        ...
        "photoLensName":
            MessageLookupByLibrary.simpleMessage("Objektivnamn från exif"),
        "photoLongitude": MessageLookupByLibrary.simpleMessage(
            "Longitud för foto GPS från exif"),
        "photoPhotographer":
            MessageLookupByLibrary.simpleMessage("Fotografnamn från exif"),
        "photoShutter":
            MessageLookupByLibrary.simpleMessage("Slutartid från exif"),
        "photoTime":
            MessageLookupByLibrary.simpleMessage("Fotograferingstid från exif"),
        ...
        "ratingGitHub":
            MessageLookupByLibrary.simpleMessage("Stjärnmärk den på GitHub"),
        "ratingStore":
            MessageLookupByLibrary.simpleMessage("Betygsätt appen i butiken"),
        "ratingTitle":
            MessageLookupByLibrary.simpleMessage("Betygsätt Vår App"),
        "rearrange": MessageLookupByLibrary.simpleMessage("Ordna om"),
        "rearrangeDelimiter":
            MessageLookupByLibrary.simpleMessage("Ordna om avgränsare"),
        "rearrangeOrderHint":
            MessageLookupByLibrary.simpleMessage("nummer separerade med komma"),
        "rearrangeOrderLabel":
            MessageLookupByLibrary.simpleMessage("Ordna om ordning"),
        ...
        "removeCharacters":
            MessageLookupByLibrary.simpleMessage("Ta bort tecken mellan dem"),
        "removeFile": MessageLookupByLibrary.simpleMessage("Ta bort fil"),
        "removeRenamed":
            MessageLookupByLibrary.simpleMessage("Ta bort omdöpta filer"),
        "removeRule":
            MessageLookupByLibrary.simpleMessage("Ta bort denna regel"),
        ...
        "renameFailed":
            MessageLookupByLibrary.simpleMessage("Namnbyte misslyckades"),
        ...
        "showHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Visa dolda filer"),
        ...
        "themeModeDark": MessageLookupByLibrary.simpleMessage("Mörkt läge"),
        "themeModeLight": MessageLookupByLibrary.simpleMessage("Ljust läge"),
        "themeModeSystem": MessageLookupByLibrary.simpleMessage("Följ system"),
