...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(error) => "Falha na renomeação por IA: ${error}";

  static String m1(requirements) => "Renomeação por IA: ${requirements}";

  static String m2(count) =>
      "Regra de renomeação por IA criada. ${count} arquivos serão renomeados.";

  static String m3(prefix) => "Incrementar: ${prefix} - índice";
  ...
  static String m6(targetString) => "Remover: \"${targetString}\"";
  ...
  static String m10(last) => "Última modificação em ${last}.";
  ...
  static String m13(type) => "Transliterar: ${type}.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("Adicionar tag de metadados"),
        ...
        "aiRenameRequirementsHint": MessageLookupByLibrary.simpleMessage(
            "Descreva como você quer renomear esses arquivos."),
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("Instruções de renomeação"),
        "aiRenameRulePreview": m1,
        "aiRenameSnackbarEmptyRequirements":
            MessageLookupByLibrary.simpleMessage(
                "Informe as instruções de renomeação"),
        ...
        "aiRenameSuccess": m2,
        "aiRenameTitle":
            MessageLookupByLibrary.simpleMessage("Renomeação por IA"),
        "androidRemindContent": MessageLookupByLibrary.simpleMessage(
            "Usando o Assistente de Renomeação de Arquivos em Lote, você pode renomear não apenas arquivos, mas também diretórios. Pressione e segure um diretório para selecioná-lo e, em seguida, selecione \'Arquivos e diretórios\' no botão suspenso no canto superior esquerdo para habilitar a renomeação de diretórios. Por motivos de segurança, alguns diretórios reservados pelo sistema não são selecionáveis."),
        "androidRemindTitle":
        ...
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("Copiar pilha de erros"),
        ...
        "descriptionInsert": MessageLookupByLibrary.simpleMessage(
            "Inserir o texto especificado em uma posição específica."),
        ...
        "descriptionRemove": MessageLookupByLibrary.simpleMessage(
            "Remover o texto especificado do nome do arquivo."),
        "descriptionReplace": MessageLookupByLibrary.simpleMessage(
            "Substituir o texto especificado pelo texto de substituição fornecido."),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("Seguir idioma do sistema"),
        ...
        "themeModeDark": MessageLookupByLibrary.simpleMessage("Modo escuro"),
        "themeModeLight": MessageLookupByLibrary.simpleMessage("Modo claro"),
        "themeModeSystem":
