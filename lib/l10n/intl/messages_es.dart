...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(error) => "Error en el renombrado con IA: ${error}";

  static String m1(requirements) => "Renombrado con IA: ${requirements}";

  static String m2(count) =>
      "Regla de renombrado con IA creada. Se renombrarán ${count} archivos.";

  static String m3(prefix) => "Incrementar con \"${prefix}\" e índice";
  ...
  static String m10(last) => "Última modificación: ${last}.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "descriptionInsert": MessageLookupByLibrary.simpleMessage(
      "Insertar texto especificado en la posición especificada.",
    ),
    ...
    "descriptionRemove": MessageLookupByLibrary.simpleMessage(
      "Eliminar texto especificado del nombre del archivo.",
    ),
    "descriptionReplace": MessageLookupByLibrary.simpleMessage(
      "Reemplazar texto especificado con el texto de reemplazo especificado.",
    ),
    ...
    "removeFile": MessageLookupByLibrary.simpleMessage("Eliminar archivo"),
    ...
    "themeModeDark": MessageLookupByLibrary.simpleMessage("Modo oscuro"),
