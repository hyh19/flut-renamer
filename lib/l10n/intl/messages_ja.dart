...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(error) => "AI リネームに失敗しました: ${error}";

  static String m1(requirements) => "AI リネーム: ${requirements}";

  static String m2(count) => "AI リネームルールを作成しました。${count} 件のファイルがリネームされます。";

  static String m3(prefix) => "増分：${prefix}インデックス";
  ...
  static String m5(delimiter, order) => "並べ替え：区切り文字：${delimiter}、順序：${order}。";

  static String m6(targetString) => "削除：「${targetString}」";

  static String m7(targetString, replacementString) =>
      "置換：「${targetString}」を「${replacementString}」に置換します。";

  static String m8(toEnd) => "開始から終わりまでの数え方を切り替え、現在は${Intl.select(toEnd, {
            'true': '終わり',
            'false': '始まり',
            'other': '',
          })}から数えています";
  ...
  static String m10(last) => "最終更新日は${last}です。";

  static String m11(last, size) => "最終更新日は${last}、ファイルサイズは${size}です。";
  ...
  static String m13(type) => "転写：${type}。";

  static String m14(langName, type) => "転写：${type}：${langName}。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("リネーム手順"),
        "aiRenameRulePreview": m1,
        "aiRenameSnackbarEmptyRequirements":
            MessageLookupByLibrary.simpleMessage("リネーム手順を入力してください"),
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("ファイルが選択されていません"),
        "aiRenameSubmit": MessageLookupByLibrary.simpleMessage("送信"),
        "aiRenameSuccess": m2,
        ...
        "descriptionInsert":
            MessageLookupByLibrary.simpleMessage("指定された位置に指定されたテキストを挿入します。"),
        "descriptionRearrange": MessageLookupByLibrary.simpleMessage(
            "ファイル名を指定された区切り文字で分割し、提供された順序に従って並べ替えます。"),
        "descriptionRemove":
            MessageLookupByLibrary.simpleMessage("指定されたテキストをファイル名から削除します。"),
        "descriptionReplace":
            MessageLookupByLibrary.simpleMessage("指定されたテキストを指定されたテキストで置換します。"),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("システム言語に従う"),
        "limit": MessageLookupByLibrary.simpleMessage("回数制限"),
        "lowercaseAppName":
            MessageLookupByLibrary.simpleMessage("ファイル一括リネームアシスタント"),
        ...
        "semanticNumberWithDirection":
            MessageLookupByLibrary.simpleMessage("最初からと最後からのカウント方向の切り替え"),
        ...
        "themeModeDark": MessageLookupByLibrary.simpleMessage("ダークモード"),
        "themeModeLight": MessageLookupByLibrary.simpleMessage("ライトモード"),
        "themeModeSystem": MessageLookupByLibrary.simpleMessage("システムに従う"),
