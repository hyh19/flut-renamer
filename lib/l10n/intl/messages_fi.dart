...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "Lisää \"${insert}\" ${insertIndex}${Intl.select(ordinal, {
            'o1': '.',
            'o2': '.',
            'o3': '.',
            'other': '.',
  ...
  static String m8(toEnd) =>
      "Vaihtaa laskentasuuntaa alusta ja lopusta, laskee tällä hetkellä ${Intl.select(toEnd, {
            'true': 'lopusta',
            'false': 'alusta',
            'other': '',
          })}";
  ...
  static String m12(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {
            ...
            'Directory': 'Kansio',
            'Link': 'Linkki',
            'other': 'Tiedostojärjestelmäyksikkö',
          })}, tiedostonimi on ${filename}, ";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
          iOne, iTwo) =>
      "Katkaise: ${Intl.select(keepType, {
            'true': 'pitä vain',
            'false': 'poista',
            'other': '',
          })} merkit ${iOne}${Intl.select(iTwoOrdinal, {
            'o1': '.',
            'o2': '.',
            'o3': '.',
            'other': '.',
            ...
            'false': '',
            'other': '',
          })} merkin ja ${iTwo}${Intl.select(iOneOrdinal, {
            'o1': '.',
            'o2': '.',
            'o3': '.',
            'other': '.',
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("Lisää metatietotunniste"),
        ...
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("Uudelleennimeämisohjeet"),
        "aiRenameRulePreview": m1,
        "aiRenameSnackbarEmptyRequirements":
            MessageLookupByLibrary.simpleMessage(
                "Syötä uudelleennimeämisohjeet"),
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("Ei tiedostoja valittu"),
        "aiRenameSubmit": MessageLookupByLibrary.simpleMessage("Lähetä"),
        "aiRenameSuccess": m2,
        "aiRenameTitle":
            MessageLookupByLibrary.simpleMessage("AI Uudelleennimeäminen"),
        ...
        "androidRemindTitle":
            MessageLookupByLibrary.simpleMessage("Nimeä hakemisto uudelleen"),
        ...
        "errorDetails":
            MessageLookupByLibrary.simpleMessage("Virheen yksityiskohdat"),
        ...
        "expandOptions":
            MessageLookupByLibrary.simpleMessage("Laajenna asetukset"),
        "fileAlreadyExists": MessageLookupByLibrary.simpleMessage(
            "Tiedostonimi on jo käytössä toisessa tiedostossa"),
        "fileCreateDate":
            MessageLookupByLibrary.simpleMessage("Tiedoston luontipäivämäärä"),
        "fileCreateTime":
            MessageLookupByLibrary.simpleMessage("Tiedoston luontiaika"),
        "fileManagerBackButton":
            MessageLookupByLibrary.simpleMessage("Takaisin"),
        "fileManagerSaveButton":
            MessageLookupByLibrary.simpleMessage("Lisää valinnat listaan"),
        "fileManagerSortButton":
            MessageLookupByLibrary.simpleMessage("Lajittele"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("Valitse tallennustila"),
        "fileModifyDate": MessageLookupByLibrary.simpleMessage(
            "Tiedoston muokkauspäivämäärä"),
        "fileModifyTime":
            MessageLookupByLibrary.simpleMessage("Tiedoston muokkausaika"),
        "fileNotExist":
            MessageLookupByLibrary.simpleMessage("Tiedostoa ei ole olemassa"),
        ...
        "filesDirs":
            MessageLookupByLibrary.simpleMessage("Tiedostot ja hakemistot"),
        ...
        "hideHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Piilota piilotiedostot"),
        "ifFileNotShown": MessageLookupByLibrary.simpleMessage(
            "Jos tiedostoja ei näy tiedostoluettelossa, tyhjennä kaikki ja jatka."),
        "ignoreExtension":
            MessageLookupByLibrary.simpleMessage("Ohita Tiedostopääte"),
        "increment": MessageLookupByLibrary.simpleMessage("Kasvata"),
        "incrementToString": m3,
        "indexIncrementalStep":
            MessageLookupByLibrary.simpleMessage("Indeksin kasvuväli"),
        "indexOne":
            MessageLookupByLibrary.simpleMessage("Ensimmäisen merkin indeksi"),
        "indexTwo":
            MessageLookupByLibrary.simpleMessage("Toisen merkin indeksi"),
        "insert": MessageLookupByLibrary.simpleMessage("Lisää"),
        "insertBeforeIndex":
            MessageLookupByLibrary.simpleMessage("Lisää ennen indeksiä"),
        ...
        "insertToString": m4,
        "insertedText":
            MessageLookupByLibrary.simpleMessage("Lisättävä teksti"),
        ...
        "keepCharacters":
            MessageLookupByLibrary.simpleMessage("Pidä merkit niiden välillä"),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("Käytä järjestelmän kieltä"),
        ...
        "musicAlbumArtist":
            MessageLookupByLibrary.simpleMessage("Albumin artistin nimi"),
        "musicAlbumLength":
            MessageLookupByLibrary.simpleMessage("Kappaleiden määrä albumilla"),
        ...
        "musicDiscNumber":
            MessageLookupByLibrary.simpleMessage("Levyn sijainti"),
        ...
        "musicTrackDuration":
            MessageLookupByLibrary.simpleMessage("Kappaleen kesto"),
        "musicTrackName":
            MessageLookupByLibrary.simpleMessage("Kappaleen nimi"),
        "musicTrackNumber": MessageLookupByLibrary.simpleMessage(
            "Kappaleen sijainti albumilla"),
        "musicWriter":
            MessageLookupByLibrary.simpleMessage("Kappaleen kirjoittaja"),
        "musicYear":
            MessageLookupByLibrary.simpleMessage("Kappaleen julkaisuvuosi"),
        "newName":
            MessageLookupByLibrary.simpleMessage("Uuden nimen esikatselu"),
        ...
        "osTodayDate":
            MessageLookupByLibrary.simpleMessage("Tämän päivän päivämäärä"),
        ...
        "photoAperture":
            MessageLookupByLibrary.simpleMessage("Aukon arvo exifistä"),
        "photoCamName":
            MessageLookupByLibrary.simpleMessage("Kameran nimi exifistä"),
        ...
        "photoFocalLength":
            MessageLookupByLibrary.simpleMessage("Polttoväli exifistä"),
        ...
        "photoLensName":
            MessageLookupByLibrary.simpleMessage("Linssin nimi exifistä"),
        "photoLongitude": MessageLookupByLibrary.simpleMessage(
            "Valokuvan GPS-pituusaste exifistä"),
        "photoPhotographer":
            MessageLookupByLibrary.simpleMessage("Valokuvaajan nimi exifistä"),
        "photoShutter":
            MessageLookupByLibrary.simpleMessage("Suljinajanopeus exifistä"),
        "photoTime":
            MessageLookupByLibrary.simpleMessage("Valokuvausaika exifistä"),
        ...
        "ratingGitHub":
            MessageLookupByLibrary.simpleMessage("Tähditä se GitHubissa"),
        "ratingStore":
            MessageLookupByLibrary.simpleMessage("Arvioi sovellus kaupassa"),
        "ratingTitle":
            MessageLookupByLibrary.simpleMessage("Arvioi Sovelluksemme"),
        "rearrange": MessageLookupByLibrary.simpleMessage("Järjestä uudelleen"),
        "rearrangeDelimiter":
            MessageLookupByLibrary.simpleMessage("Järjestä uudelleen erotin"),
        ...
        "removeRule":
            MessageLookupByLibrary.simpleMessage("Poista tämä sääntö"),
        ...
        "showHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Näytä piilotiedostot"),
        ...
        "themeModeSystem":
            MessageLookupByLibrary.simpleMessage("Seuraa järjestelmää"),
