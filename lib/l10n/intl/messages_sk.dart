...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "Vložit \"${insert}\" na ${insertIndex}${Intl.select(ordinal, {
            'o1': '.',
            'o2': '.',
            'o3': '.',
            'other': '.',
  ...
  static String m8(toEnd) =>
      "Přepínání směru počítání mezi od začátku a od konce, aktuálně počítání od ${Intl.select(toEnd, {
            'true': 'konce',
            'false': 'začátku',
            'other': '',
          })}";
  ...
  static String m12(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {
            ...
            'Directory': 'Složka',
            'Link': 'Odkaz',
            'other': 'Entita systému souborů',
          })}, název souboru je ${filename}, ";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
          iOne, iTwo) =>
      "Zkrátit: ${Intl.select(keepType, {
            'true': 'zachovat pouze',
            'false': 'odstranit',
            'other': '',
          })} znaky mezi ${iOne}${Intl.select(iTwoOrdinal, {
            'o1': '.',
            'o2': '.',
            'o3': '.',
            'other': '.',
            ...
            'false': '',
            'other': '',
          })} znakem a ${iTwo}${Intl.select(iOneOrdinal, {
            'o1': '.',
            'o2': '.',
            'o3': '.',
            'other': '.',
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("Přidat tag metadat"),
        ...
        "aiRenameRequirementsLabel":
            MessageLookupByLibrary.simpleMessage("Instrukce pro přejmenování"),
        ...
        "aiRenameSnackbarNoSelection":
            MessageLookupByLibrary.simpleMessage("Nevybrány žádné soubory"),
        "aiRenameSubmit": MessageLookupByLibrary.simpleMessage("Odeslat"),
        "aiRenameSuccess": m2,
        "aiRenameTitle":
            MessageLookupByLibrary.simpleMessage("AI Přejmenování"),
        "androidRemindContent": MessageLookupByLibrary.simpleMessage(
            "Pomocou Premenovanie Súborov môžete premenovávať nielen súbory, ale aj adresáre. Dlhým stlačením vyberte adresár a potom vyberte \'Súbory a adresáre\' z rozbaľovacieho tlačidla v ľavom hornom rohu, aby ste povolili premenovanie adresárov. Z bezpečnostných dôvodov nie sú niektoré systémové rezervované adresáre vyberateľné."),
        "androidRemindTitle":
            MessageLookupByLibrary.simpleMessage("Přejmenovat adresář"),
        ...
        "appName": MessageLookupByLibrary.simpleMessage("Premenovanie Súborov"),
        ...
        "collapseOptions":
            MessageLookupByLibrary.simpleMessage("Sbalit možnosti"),
        "colorPicker": MessageLookupByLibrary.simpleMessage("Výběr barvy"),
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("Kopírovat zásobník chyb"),
        ...
        "doNotRemindAgain":
            MessageLookupByLibrary.simpleMessage("OK. Už mi to nepřipomínej."),
        ...
        "dropToAdd":
            MessageLookupByLibrary.simpleMessage("Pusťte pro přidání souborů."),
        "errorDetails":
            MessageLookupByLibrary.simpleMessage("Podrobnosti chyby"),
        ...
        "expandOptions":
            MessageLookupByLibrary.simpleMessage("Rozbalit možnosti"),
        "fileAlreadyExists": MessageLookupByLibrary.simpleMessage(
            "Název souboru je již používán jiným souborem"),
        "fileCreateDate":
            MessageLookupByLibrary.simpleMessage("Datum vytvoření souboru"),
        "fileCreateTime":
            MessageLookupByLibrary.simpleMessage("Čas vytvoření souboru"),
        "fileManagerBackButton": MessageLookupByLibrary.simpleMessage("Zpět"),
        "fileManagerSaveButton":
            MessageLookupByLibrary.simpleMessage("Přidat výběry do seznamu"),
        "fileManagerSortButton":
            MessageLookupByLibrary.simpleMessage("Seřadit podle"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("Vybrat úložiště"),
        "fileModifyDate":
            MessageLookupByLibrary.simpleMessage("Datum úpravy souboru"),
        "fileModifyTime":
            MessageLookupByLibrary.simpleMessage("Čas úpravy souboru"),
        "fileNotExist":
            MessageLookupByLibrary.simpleMessage("Soubor neexistuje"),
        ...
        "hideHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Skrýt skryté soubory"),
        ...
        "ignoreExtension":
            MessageLookupByLibrary.simpleMessage("Ignorovat Příponu"),
        "increment": MessageLookupByLibrary.simpleMessage("Zvýšit"),
        "incrementToString": m3,
        "indexIncrementalStep":
            MessageLookupByLibrary.simpleMessage("Krok přírůstku indexu"),
        ...
        "insertBeforeIndex":
            MessageLookupByLibrary.simpleMessage("Vložit před index"),
        ...
        "iosRemindTitle":
            MessageLookupByLibrary.simpleMessage("O výběru souborů v iOS"),
        "isRegex": MessageLookupByLibrary.simpleMessage("Je regex"),
        "keepCharacters":
            MessageLookupByLibrary.simpleMessage("Zachovat znaky mezi nimi"),
        "language": MessageLookupByLibrary.simpleMessage("Jazyk: "),
        "languageEnglishOnly":
            MessageLookupByLibrary.simpleMessage("Angličtina"),
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("Použít jazyk systému"),
        "limit": MessageLookupByLibrary.simpleMessage("limit"),
        "lowercaseAppName":
            MessageLookupByLibrary.simpleMessage("premenovanie súborov"),
        ...
        "musicAlbumArtist":
            MessageLookupByLibrary.simpleMessage("Jméno umělce alba"),
        "musicAlbumLength":
            MessageLookupByLibrary.simpleMessage("Počet skladeb v albu"),
        ...
        "musicGenres":
            MessageLookupByLibrary.simpleMessage("Umělecký typ hudby"),
        "musicTrackArtist": MessageLookupByLibrary.simpleMessage(
            "Jména umělců vystupujících ve skladbě"),
        "musicTrackDuration":
            MessageLookupByLibrary.simpleMessage("Délka skladby"),
        "musicTrackName": MessageLookupByLibrary.simpleMessage("Název skladby"),
        "musicTrackNumber":
            MessageLookupByLibrary.simpleMessage("Pozice skladby v albu"),
        "musicWriter":
            MessageLookupByLibrary.simpleMessage("Spisovatel skladby"),
        "musicYear": MessageLookupByLibrary.simpleMessage("Rok vydání skladby"),
        "newName": MessageLookupByLibrary.simpleMessage("Náhľad nového názvu"),
        ...
        "photoAperture":
            MessageLookupByLibrary.simpleMessage("Hodnota clony z exif"),
        "photoCamName":
            MessageLookupByLibrary.simpleMessage("Název fotoaparátu z exif"),
        "photoCopyright": MessageLookupByLibrary.simpleMessage(
            "Jméno držitele autorských práv z exif"),
        "photoDate":
            MessageLookupByLibrary.simpleMessage("Datum fotografování z exif"),
        "photoFocalLength":
            MessageLookupByLibrary.simpleMessage("Ohnisková vzdálenost z exif"),
        ...
        "photoLensName":
            MessageLookupByLibrary.simpleMessage("Název objektivu z exif"),
        "photoLongitude": MessageLookupByLibrary.simpleMessage(
            "Zeměpisná délka GPS fotografie z exif"),
        "photoPhotographer":
            MessageLookupByLibrary.simpleMessage("Jméno fotografa z exif"),
        "photoShutter":
            MessageLookupByLibrary.simpleMessage("Rychlost závěrky z exif"),
        "photoTime":
            MessageLookupByLibrary.simpleMessage("Čas fotografování z exif"),
        ...
        "ratingTitle":
            MessageLookupByLibrary.simpleMessage("Ohodnoťte Naši Aplikaci"),
        "rearrange": MessageLookupByLibrary.simpleMessage("Přeuspořádat"),
        "rearrangeDelimiter":
            MessageLookupByLibrary.simpleMessage("Oddělovač přeuspořádání"),
        "rearrangeOrderHint":
            MessageLookupByLibrary.simpleMessage("čísla oddělená čárkou"),
        "rearrangeOrderLabel":
            MessageLookupByLibrary.simpleMessage("Pořadí přeuspořádání"),
        ...
        "removeCharacters":
            MessageLookupByLibrary.simpleMessage("Odstranit znaky mezi nimi"),
        ...
        "removeRule":
            MessageLookupByLibrary.simpleMessage("Odstranit toto pravidlo"),
        ...
        "renameFailed":
            MessageLookupByLibrary.simpleMessage("Přejmenování selhalo"),
        ...
        "showHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Zobrazit skryté soubory"),
        ...
        "themeModeSystem":
            MessageLookupByLibrary.simpleMessage("Sledovat systém"),
        ...
        "transliterateCyrillic2Latin":
            MessageLookupByLibrary.simpleMessage("Cyrilské znaky na latinské"),
        "transliterateLatin2Cyrillic":
            MessageLookupByLibrary.simpleMessage("Latinské znaky na cyrilské"),
        "transliterateLower": MessageLookupByLibrary.simpleMessage(
            "Latinské znaky na malá písmena"),
        "transliteratePinyin":
            MessageLookupByLibrary.simpleMessage("Čínské znaky na pinyin"),
