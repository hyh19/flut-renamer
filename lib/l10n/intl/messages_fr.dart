...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(error) => "Échec du renommage par IA : ${error}";

  static String m1(requirements) => "Renommage par IA : ${requirements}";

  static String m2(count) =>
      "Règle de renommage par IA créée. ${count} fichiers seront renommés.";

  static String m3(prefix) => "Incrémentation : ${prefix} - Index";
  ...
  static String m6(targetString) => "Suppression : \"${targetString}\"";
  ...
  static String m10(last) => "Dernière modification : ${last}.";
  ...
  static String m13(type) => "Translittération : ${type}.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addMetadataTag": MessageLookupByLibrary.simpleMessage(
      "Ajouter une balise de métadonnées",
    ),
    ...
    "colorPicker": MessageLookupByLibrary.simpleMessage("Sélecteur de couleur"),
    "copyErrorStack": MessageLookupByLibrary.simpleMessage(
      "Copier la pile d\'erreurs",
    ),
    ...
    "descriptionInsert": MessageLookupByLibrary.simpleMessage(
      "Insérer le texte spécifié à la position spécifiée dans le nom de fichier.",
    ),
    ...
    "descriptionRemove": MessageLookupByLibrary.simpleMessage(
      "Supprimer le texte spécifié du nom de fichier.",
    ),
    "descriptionReplace": MessageLookupByLibrary.simpleMessage(
      "Remplacer le texte spécifié par le texte de remplacement donné.",
    ),
    ...
    "manualMode": MessageLookupByLibrary.simpleMessage("Mode manuel"),
    ...
    "removeFile": MessageLookupByLibrary.simpleMessage("Supprimer le fichier"),
    ...
    "renameSuccess": MessageLookupByLibrary.simpleMessage("Renommage réussi"),
