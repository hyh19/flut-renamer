...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "Вставить \"${insert}\" в ${insertIndex}${Intl.select(ordinal, {
            'o1': 'й',
            'o2': 'й',
            'o3': 'й',
            'other': 'й',
  ...
  static String m8(toEnd) =>
      "Переключение направления подсчета между от начала и от конца, в настоящее время подсчет от ${Intl.select(toEnd, {
            'true': 'конца',
            'false': 'начала',
            'other': '',
          })}";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
          iOne, iTwo) =>
      "Обрезать: ${Intl.select(keepType, {
            'true': 'оставить только',
            'false': 'удалить',
            'other': '',
          })} символы между ${iOne}${Intl.select(iTwoOrdinal, {
            'o1': 'м',
            'o2': 'м',
            'o3': 'м',
            'other': 'м',
            ...
            'false': '',
            'other': '',
          })} символом и ${iTwo}${Intl.select(iOneOrdinal, {
            'o1': 'м',
            'o2': 'м',
            'o3': 'м',
            'other': 'м',
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addMetadataTag":
            MessageLookupByLibrary.simpleMessage("Добавить тег метаданных"),
        ...
        "aiRenameSuccess": m2,
        "aiRenameTitle":
            MessageLookupByLibrary.simpleMessage("ИИ переименование"),
        ...
        "androidRemindTitle":
            MessageLookupByLibrary.simpleMessage("Переименование каталога"),
        ...
        "appName":
            MessageLookupByLibrary.simpleMessage("Переименование файлов"),
        ...
        "collapseOptions":
            MessageLookupByLibrary.simpleMessage("Свернуть опции"),
        "colorPicker": MessageLookupByLibrary.simpleMessage("Выбор цвета"),
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("Копировать стек ошибок"),
        ...
        "doNotRemindAgain":
            MessageLookupByLibrary.simpleMessage("ОК. Больше не напоминать."),
        ...
        "expandOptions":
            MessageLookupByLibrary.simpleMessage("Развернуть опции"),
        "fileAlreadyExists": MessageLookupByLibrary.simpleMessage(
            "Имя файла уже используется другим файлом"),
        "fileCreateDate":
            MessageLookupByLibrary.simpleMessage("Дата создания файла"),
        "fileCreateTime":
            MessageLookupByLibrary.simpleMessage("Время создания файла"),
        "fileManagerBackButton": MessageLookupByLibrary.simpleMessage("Назад"),
        "fileManagerSaveButton":
            MessageLookupByLibrary.simpleMessage("Добавить выбранные в список"),
        "fileManagerSortButton":
            MessageLookupByLibrary.simpleMessage("Сортировать по"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("Выбрать хранилище"),
        "fileModifyDate":
            MessageLookupByLibrary.simpleMessage("Дата изменения файла"),
        "fileModifyTime":
            MessageLookupByLibrary.simpleMessage("Время изменения файла"),
        "fileNotExist":
        ...
        "hideHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Скрыть скрытые файлы"),
        "ifFileNotShown": MessageLookupByLibrary.simpleMessage(
            "Если файлы не отображаются в списке файлов, очистите все и продолжите."),
        "ignoreExtension":
            MessageLookupByLibrary.simpleMessage("Игнорировать расширение"),
        "increment": MessageLookupByLibrary.simpleMessage("Увеличить"),
        "incrementToString": m3,
        "indexIncrementalStep":
            MessageLookupByLibrary.simpleMessage("Шаг приращения индекса"),
        "indexOne":
            MessageLookupByLibrary.simpleMessage("Индекс первого символа"),
        "indexTwo":
            MessageLookupByLibrary.simpleMessage("Индекс второго символа"),
        "insert": MessageLookupByLibrary.simpleMessage("Вставить"),
        "insertBeforeIndex":
            MessageLookupByLibrary.simpleMessage("Вставить перед индексом"),
        ...
        "insertToString": m4,
        "insertedText":
            MessageLookupByLibrary.simpleMessage("Текст для вставки"),
        ...
        "iosRemindTitle":
            MessageLookupByLibrary.simpleMessage("О выборе файлов в iOS"),
        ...
        "languageFollowSystem":
            MessageLookupByLibrary.simpleMessage("Следовать языку системы"),
        ...
        "musicAlbumArtist":
            MessageLookupByLibrary.simpleMessage("Имя артиста альбома"),
        "musicAlbumLength":
            MessageLookupByLibrary.simpleMessage("Количество треков в альбоме"),
        "musicAlbumName":
            MessageLookupByLibrary.simpleMessage("Название альбома"),
        "musicAuthor": MessageLookupByLibrary.simpleMessage("Автор трека"),
        "musicDiscNumber":
            MessageLookupByLibrary.simpleMessage("Позиция диска"),
        "musicGenres":
            MessageLookupByLibrary.simpleMessage("Художественный тип музыки"),
        "musicTrackArtist": MessageLookupByLibrary.simpleMessage(
            "Имена артистов, исполняющих трек"),
        "musicTrackDuration":
            MessageLookupByLibrary.simpleMessage("Длительность трека"),
        "musicTrackName":
            MessageLookupByLibrary.simpleMessage("Название трека"),
        "musicTrackNumber":
            MessageLookupByLibrary.simpleMessage("Позиция трека в альбоме"),
        "musicWriter": MessageLookupByLibrary.simpleMessage("Писатель трека"),
        "musicYear":
            MessageLookupByLibrary.simpleMessage("Год публикации трека"),
        "newName":
            MessageLookupByLibrary.simpleMessage("Предпросмотр нового имени"),
        ...
        "onlySelected":
            MessageLookupByLibrary.simpleMessage("Только выбранные"),
        ...
        "photoAperture":
            MessageLookupByLibrary.simpleMessage("Значение диафрагмы из exif"),
        "photoCamName":
            MessageLookupByLibrary.simpleMessage("Название камеры из exif"),
        ...
        "photoFocalLength":
            MessageLookupByLibrary.simpleMessage("Фокусное расстояние из exif"),
        "photoISO":
            MessageLookupByLibrary.simpleMessage("Значение ISO из exif"),
        "photoLatitude": MessageLookupByLibrary.simpleMessage(
            "Широта GPS фотографии из exif"),
        "photoLensName":
            MessageLookupByLibrary.simpleMessage("Название объектива из exif"),
        "photoLongitude": MessageLookupByLibrary.simpleMessage(
            "Долгота GPS фотографии из exif"),
        "photoPhotographer":
            MessageLookupByLibrary.simpleMessage("Имя фотографа из exif"),
        "photoShutter":
            MessageLookupByLibrary.simpleMessage("Скорость затвора из exif"),
        ...
        "ratingGitHub":
            MessageLookupByLibrary.simpleMessage("Поставить звезду на GitHub"),
        "ratingStore": MessageLookupByLibrary.simpleMessage(
            "Оценить приложение в магазине"),
        "ratingTitle":
            MessageLookupByLibrary.simpleMessage("Оцените наше приложение"),
        "rearrange": MessageLookupByLibrary.simpleMessage("Переставить"),
        "rearrangeDelimiter":
            MessageLookupByLibrary.simpleMessage("Разделитель перестановки"),
        "rearrangeOrderHint":
            MessageLookupByLibrary.simpleMessage("числа, разделенные запятой"),
        "rearrangeOrderLabel":
            MessageLookupByLibrary.simpleMessage("Порядок перестановки"),
        "rearrangeToString": m5,
        "remove": MessageLookupByLibrary.simpleMessage("Удалить"),
        "removeAll": MessageLookupByLibrary.simpleMessage("Удалить все"),
        "removeCharacters":
            MessageLookupByLibrary.simpleMessage("Удалить символы между ними"),
        ...
        "removeRule":
            MessageLookupByLibrary.simpleMessage("Удалить это правило"),
        "removeRules": MessageLookupByLibrary.simpleMessage(
            "Удалить правила после переименования"),
        "removeToString": m6,
        "rename": MessageLookupByLibrary.simpleMessage("Переименовать"),
        "renameFailed":
            MessageLookupByLibrary.simpleMessage("Переименование не удалось"),
        ...
        "showHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Показать скрытые файлы"),
        ...
        "themeModeSystem":
            MessageLookupByLibrary.simpleMessage("Следовать системе"),
        ...
        "transliteratePinyin":
            MessageLookupByLibrary.simpleMessage("Китайские символы в пиньинь"),
