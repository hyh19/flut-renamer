...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "androidRemindContent": MessageLookupByLibrary.simpleMessage(
      "Χρησιμοποιώντας το Flut Renamer, μπορείτε να μετονομάσετε όχι μόνο αρχεία αλλά και καταλόγους. Πατήστε παρατεταμένα έναν κατάλογο για να τον επιλέξετε και επιλέξτε \'Αρχεία & Κατάλογοι\' από το κουμπί αναπτυσσόμενης λίστας στην επάνω αριστερή γωνία για να ενεργοποιήσετε τη μετονομασία καταλόγων. Για λόγους ασφαλείας, ορισμένοι συστηματικοί δεσμευμένοι κατάλογοι δεν είναι επιλέξιμοι.",
    ),
