...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m4(toEnd, ordinal, insert, insertIndex) =>
      "Εισαγωγή \"${insert}\" στο ${insertIndex}${Intl.select(ordinal, {
            'o1': 'ο',
            'o2': 'ο',
            'o3': 'ο',
            'other': 'ο',
  ...
  static String m8(toEnd) =>
      "Εναλλαγή κατεύθυνσης μέτρησης μεταξύ από την αρχή και από το τέλος, επί του παρόντος μέτρηση από ${Intl.select(toEnd, {
            'true': 'το τέλος',
            'false': 'την αρχή',
            'other': '',
          })}";
  ...
  static String m12(entityType, selectStatus, filename) =>
      "${Intl.select(selectStatus, {
            ...
            'Directory': 'Φάκελος',
            'Link': 'Σύνδεσμος',
            'other': 'Οντότητα συστήματος αρχείων',
          })}, το όνομα αρχείου είναι ${filename}, ";
  ...
  static String m15(iTwoToEnd, iOneOrdinal, iOneToEnd, iTwoOrdinal, keepType,
      ...
      "Περικοπή: ${Intl.select(keepType, {
            ...
            'false': 'αφαίρεση',
            'other': '',
          })} χαρακτήρες μεταξύ ${iOne}${Intl.select(iTwoOrdinal, {
            'o1': 'ου',
            'o2': 'ου',
            'o3': 'ου',
            'other': 'ου',
            ...
            'false': '',
            'other': '',
          })} χαρακτήρα και ${iTwo}${Intl.select(iOneOrdinal, {
            'o1': 'ου',
            'o2': 'ου',
            'o3': 'ου',
            'other': 'ου',
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "androidRemindTitle":
            MessageLookupByLibrary.simpleMessage("Μετονομασία καταλόγου"),
        "appError": MessageLookupByLibrary.simpleMessage("Σφάλμα εφαρμογής"),
        "appInfo":
            MessageLookupByLibrary.simpleMessage("Πληροφορίες εφαρμογής"),
        ...
        "caseSensitive":
            MessageLookupByLibrary.simpleMessage("Ευαίσθητο σε πεζά-κεφαλαία"),
        "collapseOptions":
            MessageLookupByLibrary.simpleMessage("Σύμπτυξη επιλογών"),
        "colorPicker":
            MessageLookupByLibrary.simpleMessage("Επιλογέας χρώματος"),
        "copyErrorStack":
            MessageLookupByLibrary.simpleMessage("Αντιγραφή στοίβας σφαλμάτων"),
        ...
        "errorDetails":
            MessageLookupByLibrary.simpleMessage("Λεπτομέρειες σφάλματος"),
        ...
        "expandOptions":
            MessageLookupByLibrary.simpleMessage("Επέκταση επιλογών"),
        ...
        "fileCreateTime":
            MessageLookupByLibrary.simpleMessage("Ώρα δημιουργίας αρχείου"),
        "fileManagerBackButton": MessageLookupByLibrary.simpleMessage("Πίσω"),
        "fileManagerSaveButton":
            MessageLookupByLibrary.simpleMessage("Προσθήκη επιλογών στη λίστα"),
        "fileManagerSortButton":
            MessageLookupByLibrary.simpleMessage("Ταξινόμηση κατά"),
        "fileManagerStorageButton":
            MessageLookupByLibrary.simpleMessage("Επιλογή αποθήκευσης"),
        "fileModifyDate": MessageLookupByLibrary.simpleMessage(
            "Ημερομηνία τροποποίησης αρχείου"),
        "fileModifyTime":
            MessageLookupByLibrary.simpleMessage("Ώρα τροποποίησης αρχείου"),
        "fileNotExist":
            MessageLookupByLibrary.simpleMessage("Το αρχείο δεν υπάρχει"),
        ...
        "goingForward":
            MessageLookupByLibrary.simpleMessage("Προχωρώντας μπροστά"),
        "hideHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Απόκρυψη κρυφών αρχείων"),
        ...
        "ignoreExtension":
            MessageLookupByLibrary.simpleMessage("Αγνόηση Επέκτασης"),
        "increment": MessageLookupByLibrary.simpleMessage("Αύξηση"),
        "incrementToString": m3,
        "indexIncrementalStep":
            MessageLookupByLibrary.simpleMessage("Βήμα αύξησης δείκτη"),
        "indexOne":
            MessageLookupByLibrary.simpleMessage("Δείκτης πρώτου χαρακτήρα"),
        "indexTwo":
            MessageLookupByLibrary.simpleMessage("Δείκτης δεύτερου χαρακτήρα"),
        ...
        "insertIndex":
            MessageLookupByLibrary.simpleMessage("Δείκτης εισαγωγής"),
        "insertTagInsideAnother": MessageLookupByLibrary.simpleMessage(
            "Μην εισάγετε μια ετικέτα μέσα σε άλλη ετικέτα."),
        "insertToString": m4,
        "insertedText":
            MessageLookupByLibrary.simpleMessage("Κείμενο προς εισαγωγή"),
        ...
        "lowercaseAppName": MessageLookupByLibrary.simpleMessage(
            "βοηθός μαζικής μετονομασίας αρχείων"),
        "manualMode":
            MessageLookupByLibrary.simpleMessage("Χειροκίνητη Λειτουργία"),
        ...
        "metadataTags":
            MessageLookupByLibrary.simpleMessage("Ετικέτες μεταδεδομένων"),
        "mk": MessageLookupByLibrary.simpleMessage("Σλαβομακεδονικά"),
        "mn": MessageLookupByLibrary.simpleMessage("Μογγολικά"),
        "musicAlbumArtist":
            MessageLookupByLibrary.simpleMessage("Όνομα καλλιτέχνη άλμπουμ"),
        ...
        "musicAuthor":
            MessageLookupByLibrary.simpleMessage("Συγγραφέας κομματιού"),
        "musicDiscNumber": MessageLookupByLibrary.simpleMessage("Θέση δίσκου"),
        "musicGenres":
            MessageLookupByLibrary.simpleMessage("Τύπος τέχνης της μουσικής"),
        "musicTrackArtist": MessageLookupByLibrary.simpleMessage(
            "Ονόματα καλλιτεχνών που ερμηνεύουν στο κομμάτι"),
        "musicTrackDuration":
            MessageLookupByLibrary.simpleMessage("Διάρκεια κομματιού"),
        "musicTrackName":
            MessageLookupByLibrary.simpleMessage("Όνομα κομματιού"),
        "musicTrackNumber":
            MessageLookupByLibrary.simpleMessage("Θέση κομματιού στο άλμπουμ"),
        "musicWriter":
            MessageLookupByLibrary.simpleMessage("Συγγραφέας κομματιού"),
        "musicYear":
            MessageLookupByLibrary.simpleMessage("Έτος δημοσίευσης κομματιού"),
        "newName":
            MessageLookupByLibrary.simpleMessage("Προεπισκόπηση νέου ονόματος"),
        ...
        "osTodayDate":
            MessageLookupByLibrary.simpleMessage("Ημερομηνία σήμερα"),
        ...
        "photoAperture":
            MessageLookupByLibrary.simpleMessage("Τιμή διαφράγματος από exif"),
        "photoCamName":
            MessageLookupByLibrary.simpleMessage("Όνομα κάμερας από exif"),
        ...
        "photoFocalLength":
            MessageLookupByLibrary.simpleMessage("Εστιακή απόσταση από exif"),
        ...
        "photoLensName":
            MessageLookupByLibrary.simpleMessage("Όνομα φακού από exif"),
        "photoLongitude": MessageLookupByLibrary.simpleMessage(
            "Γεωγραφικό μήκος GPS φωτογραφίας από exif"),
        "photoPhotographer":
            MessageLookupByLibrary.simpleMessage("Όνομα φωτογράφου από exif"),
        "photoShutter":
            MessageLookupByLibrary.simpleMessage("Ταχύτητα κλείστρου από exif"),
        "photoTime":
            MessageLookupByLibrary.simpleMessage("Ώρα φωτογράφισης από exif"),
        ...
        "rearrangeDelimiter":
            MessageLookupByLibrary.simpleMessage("Οριοθέτης αναδιάταξης"),
        "rearrangeOrderHint": MessageLookupByLibrary.simpleMessage(
            "αριθμοί διαχωρισμένοι με κόμμα"),
        "rearrangeOrderLabel":
            MessageLookupByLibrary.simpleMessage("Σειρά αναδιάταξης"),
        ...
        "removeRule":
            MessageLookupByLibrary.simpleMessage("Αφαίρεση αυτού του κανόνα"),
        ...
        "renameFailed":
            MessageLookupByLibrary.simpleMessage("Η μετονομασία απέτυχε"),
        ...
        "showHiddenFiles":
            MessageLookupByLibrary.simpleMessage("Εμφάνιση κρυφών αρχείων"),
        ...
        "themeModeDark":
            MessageLookupByLibrary.simpleMessage("Σκοτεινή λειτουργία"),
        "themeModeLight":
            MessageLookupByLibrary.simpleMessage("Φωτεινή λειτουργία"),
        "themeModeSystem":
            MessageLookupByLibrary.simpleMessage("Ακολούθηση συστήματος"),
